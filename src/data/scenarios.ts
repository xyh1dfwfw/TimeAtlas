...
export const atlasInquiryPaths: AtlasInquiryPath[] = [
  ...
  {
    id: 'infrastructure-progress-labor-costs',
    title: '基础设施进步的劳动代价',
    subtitle: '从苏伊士运河、曼彻斯特、孟买到 Cusco，追问道路、运河、工厂和记录系统怎样把“进步”压进普通人的身体。',
    lensKey: 'risk-safety',
    scenarioIds: ['suez-canal-corvee-water-carrier', 'industrial-manchester-mill-worker', 'colonial-bombay-mill-worker', 'inca-cusco-khipu-runner'],
    drivingQuestion: '大型基础设施和生产系统被称为进步时，谁获得速度、利润或国家能力，谁承担劳役、疾病、纪律和记录沉默？',
    whyTheseScenarios:
      '苏伊士运河劳役送水人面对国家征调、欧洲公司工程和淡水短缺；曼彻斯特与孟买工厂劳动者面对机器时间、全球棉纺和殖民城市监管；Cusco 的 khipu / 道路场景显示帝国道路、仓储和 mit’a 如何把劳动转为可调度资源。四站能把“基础设施”从地图线条改写成劳动、身体、记录和权力系统。',
    tasks: [
      '为四站各写一条“基础设施/系统—受益者—劳动承担者—风险—来源边界”的证据链。',
      '比较运河、工厂和道路/仓储：哪一种最容易被后世地图或工程数据写成进步，而遮蔽普通人的经验？',
      '用 230 字回答：进步是否可以只用通行速度、产量或国家调度能力衡量？必须说明一条缺席声音。',
    ],
    discussionMoves: [
      '先让学生把“路线变短”“生产变快”“资源可调度”改写成“谁挖、谁搬、谁喝不够水、谁被记号记录”。',
      '追问每条证据的产生者：工程公司、国家、工厂调查、殖民/帝国记录或现代研究各自为什么这样记录劳动。',
      '要求结论同时写出基础设施带来的真实能力和普通人承担的不可量化代价。',
    ],
    rubric: [
      '能把基础设施进步拆成具体节点、劳动和风险，而不是只做道德评价',
      '能比较劳役、工资劳动、殖民监管和帝国调度的不同机制',
      '至少使用四站证据，并说明工程数据、工厂记录或 khipu/编年材料的来源边界',
      '结论避免编造个人原话、精确死亡数、工时或工资，能承认普通劳动者声音缺席',
    ],
  },
]
...
export const atlasMapRoutes: AtlasMapRoute[] = [
  ...
  {
    id: 'paper-credit-rice-and-port-ledgers-route',
    title: '纸面信用、米票与港口账本路线',
    subtitle: '连接大阪堂岛、Fustat、巴格达、广州和马六甲，追问账本、票据、书信和口岸文书怎样把远方货物变成可交易承诺。',
    lensKey: 'market-exchange',
    scenarioIds: ['tokugawa-osaka-dojima-rice-ledger-apprentice', 'fustat-geniza-merchant-apprentice', 'abbasid-baghdad-scribe', 'qing-guangzhou-comprador', 'malacca-monsoon-port-broker'],
    routeQuestion: '当米、布、纸张、书信或口岸商品尚在仓库、船上或远方城市时，账本和票据如何制造信任，又把错误、延误和传闻风险转嫁给低位记录者？',
    mapFocus: '路线从 1730 年前后大阪堂岛米市出发，连接 12 世纪 Fustat 商人书信、阿拔斯巴格达纸本/账册文化、19 世纪广州口岸文书和 1511 年马六甲季风港口经纪，强调 paper credit、rice bills、merchant letters、ledgers、port brokerage、rumor 和 source limits。',
    classroomUse: '适合市场史、信用制度、来源可信度或商业中介单元；学生应把“纸面信用”拆成仓储、见证、账本核对、消息速度、监管和责任归属，而不是直接等同现代金融市场。',
    assignmentPrompt: '制作一张五站“远距离信任账本图”：每站标出一种货物或承诺、一种记录媒介、一个守门人、一个失败风险和一句来源边界。',
    evidencePrompts: [
      '在大阪站，用堂岛米市、米票、藩仓米和武士俸禄货币化证据说明实物米、仓单/米票与信用承诺的区别。',
      '在 Fustat 与巴格达站，比较商人信件、合约、纸张和抄写劳动如何让远方伙伴关系可执行。',
      '在广州与马六甲站，说明口岸账本、通译/经纪、税册和国家权力如何影响信任与追责。',
      '为每站写一句“这条来源能说明记录制度，但不能直接告诉我们哪类低位劳动者经验”。',
    ],
    deliverables: ['五站远距离信任账本图', '实物/票据/信用承诺区分表', '传闻与迟报风险链', '来源边界注释', '220 字纸面信用谨慎论证'],
    tags: ['paper credit', 'rice bills', 'Dojima', 'ledgers', 'merchant letters', 'port records', 'trust', 'source limits'],
  },
  {
  ...
  {
    id: 'canal-steam-and-labor-route',
    title: '运河、蒸汽与劳役路线',
    subtitle: '从苏伊士运河到 Fustat、马六甲、孟买和广州，追踪运河、蒸汽、港口中介与全球商品流动背后的劳动代价。',
    lensKey: 'institutional-constraints',
    scenarioIds: ['suez-canal-corvee-water-carrier', 'fustat-geniza-merchant-apprentice', 'malacca-monsoon-port-broker', 'colonial-bombay-mill-worker', 'qing-guangzhou-comprador'],
    routeQuestion: '当运河和蒸汽航运把世界想象成更短、更快、更可控时，哪些普通人的送水、记账、翻译、装卸、工厂和口岸劳动让这种连通成为可能？',
    mapFocus: '路线以 1862/1863 年苏伊士运河工地为近代节点，回看 Fustat 的红海—印度洋信用与书信，再连接马六甲季风港口、殖民孟买港口工业和广州口岸中介，强调 canal、steam、freshwater、corvée、credit、port brokerage、commodity routes 和 source limits。',
    classroomUse: '适合基础设施史、全球贸易、帝国资本或劳动史单元；学生应把地图上的捷径拆成淡水供应、劳役征调、港口文书、季风/蒸汽节律、工厂纪律和口岸风险。',
    assignmentPrompt: '制作一张五站“运河—港口—商品劳动路线图”：每站标出一种连接世界的系统、一种普通劳动、一项制度约束、一条来源证据和一句来源边界。',
    evidencePrompts: [
      '在苏伊士站，用运河公司/工程报告、外交通信或机构历史说明淡水、劳役和工程数据之间的张力。',
      '在 Fustat 与马六甲站，比较书信信用、季风等待、港口通译和税册如何让远距离交易可执行。',
      '在孟买与广州站，说明殖民工业、港口商品和口岸中介如何把全球市场压力转化为城市劳动、法律或身体风险。',
      '为每站写一句“这条来源最容易高估连接的效率，或低估哪类劳动代价”。',
    ],
    deliverables: ['五站运河—蒸汽—港口路线图', '基础设施劳动链', '制度约束比较表', '来源边界注释', '230 字基础设施进步代价论证'],
    tags: ['Suez Canal', 'steam routes', 'corvée', 'freshwater', 'ports', 'global commodities', 'labor costs'],
  },
]
...
export const communicationInquiries: CommunicationInquiry[] = [
  ...
  },
  {
    ...
    scenarioIds: ['tang-changan-merchant', 'song-bianjing-apprentice', 'tenochtitlan-market-seller', 'ottoman-istanbul-coffeehouse-apprentice', 'qing-guangzhou-comprador', 'colonial-bombay-mill-worker'],
  ...
  },
  {
    ...
    scenarioIds: ['abbasid-baghdad-scribe', 'timbuktu-manuscript-student', 'ming-jiangnan-scholar', 'ottoman-istanbul-coffeehouse-apprentice', 'fustat-geniza-merchant-apprentice', 'song-bianjing-apprentice', 'tang-changan-merchant'],
...
export const scenarios: Scenario[] = [
  ...
  {
    id: 'ottoman-istanbul-coffeehouse-apprentice',
    title: '奥斯曼伊斯坦布尔咖啡馆学徒',
    era: '奥斯曼帝国苏莱曼时代晚期',
    year: 1560,
    location: '伊斯坦布尔 Tahtakale 附近早期咖啡馆街区',
    region: '东地中海 / 奥斯曼帝国首都',
    coordinates: [41.0082, 28.9784],
    identity: '在码头与市场之间跑腿的年轻咖啡馆帮工',
    role: '煮咖啡、传话、替讲述者整理段子与替识字客人抄写短札',
    age: 16,
    theme: '咖啡馆、城市消息、口头故事、抄写、监管、传闻风险、公共生活边界',
    accent: '#8b5e34',
    summary:
      '约 1555-1565 年，你在伊斯坦布尔一间早期咖啡馆帮工。你清晨从码头和市场听来消息，午后给听故事、吟诗和议价的客人续杯，傍晚又听见关于禁令、税收、治安与宗教批评的争论。咖啡馆让消息、娱乐、争议和监管在同一城市空间交汇；你的问题不是“自由表达”是否存在，而是在谋生、转述、含糊改写和沉默之间怎样保住生计与声誉。',
    atmosphere:
      '铜锅在炭火上发出细响，烘豆烟、海风、汗味和湿木头气味混在一起。清真寺宣礼声越过街巷，码头脚夫带来埃及船期和价格消息；讲述者把笑话压低声音，顾客的杯盏一停，你就知道有一句话可能越过了安全边界。',
    sceneBeats: [
      {
        timeLabel: '清晨开炉',
        title: '咖啡香先听见码头消息',
        sensoryDetail: '你把烘过的豆子捣碎，铜 cezve 贴着炭火冒泡；门外搬夫谈起埃及船、也门咖啡和今日粮价。',
        historicalTension: '咖啡作为新饮品随贸易、朝觐与帝国城市网络进入首都，但普通帮工接触到的多是码头口耳消息，而不是完整商业账册。',
        evidenceHook: '把 Peçevi 的早期咖啡馆回忆、Hattox 的咖啡传播研究和日常工作切片并读，追问消息如何从商品流动变成街巷谈资。',
        learnerPrompt: '清晨哪一条消息最可能改变今天的生意？它是可核实事实、价格信号，还是二手传闻？',
        linkedDailyLifeKeys: ['food', 'work', 'education'],
        linkedSourceTitles: ['Peçevi History: early Istanbul coffeehouses', 'Coffee and Coffeehouses: The Origins of a Social Beverage in the Medieval Near East'],
      },
      {
        timeLabel: '午后客满',
        title: '故事、诗句和新闻同桌',
        sensoryDetail: '杯底黑渣沉下去，讲述者敲木匙起头；士人念诗，商贩插话说港口消息，旁人把笑声压进袖口。',
        historicalTension: '咖啡馆扩大了城市男性社交和娱乐空间，却不能被直接等同于现代公共舆论场；消息、诗歌和讽刺常混在表演、闲谈与生计中。',
        evidenceHook: '用 Kafadar 与 Faroqhi 的城市公共生活研究校准“公共空间”用语，再检查哪些声音只通过精英记述被看见。',
        learnerPrompt: '当故事、诗和新闻混在一起时，哪部分可以当历史证据？哪部分只能提示城市氛围？',
        linkedDailyLifeKeys: ['work', 'education', 'freedoms'],
        linkedSourceTitles: ['A History of Coffee', 'Subjects of the Sultan: Culture and Daily Life in the Ottoman Empire'],
      },
      {
        timeLabel: '傍晚压低声音',
        title: '禁令、税收和街区治安被倒进杯里',
        sensoryDetail: '日光退到木格窗外，有人谈检查、税钱和巡夜；一位年长客人提醒你别把宗教批评听成笑话。',
        historicalTension: '咖啡馆的热闹伴随道德批评、治安担忧和国家监管，城市秩序与社交机会并不是相反两端，而是在同一张桌上碰撞。',
        evidenceHook: '把 Kâtip Çelebi 对咖啡/烟草争议的回顾、kadi court records 项目和法规/治安线索放在一起，区分规范判断、执法记录和街头实践。',
        learnerPrompt: '如果一条禁令被讨论，它说明国家控制很强，还是说明现场实践仍有协商空间？需要哪类证据补充？',
        linkedDailyLifeKeys: ['risks', 'freedoms', 'work'],
        linkedSourceTitles: ['The Balance of Truth on coffee, tobacco and custom', 'Istanbul Kadı Sicilleri / Ottoman court records project'],
      },
      {
        timeLabel: '夜间收杯',
        title: '危险传闻要不要落到纸上',
        sensoryDetail: '你擦干杯沿，讲述者塞来一张折纸，叫你把今晚最尖刻的讽刺和宫中传闻整理成可复述的段子。',
        historicalTension: '抄写和转述能带来赏钱、师承和名声，也会把口头含糊变成可追责文本；帮工的能动性常体现在删改、含糊化或拒绝传播。',
        evidenceHook: '把决策题、来源可靠性提示和场景中的缺席声音连成一条“口头—抄写—监管”的证据链。',
        learnerPrompt: '把传闻写下来会增加可靠性，还是增加危险？请区分当时可知信息与后世解释。',
        linkedDailyLifeKeys: ['education', 'risks', 'freedoms', 'work'],
        linkedSourceTitles: ['Peçevi History: early Istanbul coffeehouses', 'A History of Coffee'],
      },
    ],
    dailyLife: [
      {
        ...
        label: '饮食',
        title: '面包、橄榄、稀汤与苦咖啡香',
        text: '你吃得简单：面包、橄榄、豆汤或店主给的剩食。咖啡本身多卖给顾客，香味常比杯子更属于你；但你能从豆价、糖价和客流中感到城市贸易的变化。',
      },
      {
        key: 'home',
        label: '居所',
        title: '睡在店后或师傅亲族屋里',
        text: '你可能睡在咖啡馆后间、仓角，或同乡/师傅家中。城市给你接触新人的机会，也让你依赖店主、街区名声和夜间治安。',
      },
      {
        key: 'work',
        label: '工作',
        title: '煮、端、听、记都算劳动',
        text: '你要生火、磨豆、洗杯、跑腿、招呼客人，还替讲述者记住段子或替识字客人抄短札。耳朵和手一样是谋生工具，但听见太多也会变成风险。',
      },
      {
        key: 'education',
        label: '学习',
        title: '在故事、诗句和短札里学字',
        text: '你不是 madrasa 学生，却能在抄写短句、听诗歌和观察客人争论中识字、学修辞、记地名和官职。学习来自工作副产品，也受身份、年龄和师承限制。',
      },
      {
        key: 'risks',
        label: '风险',
        title: '传错话比洒掉咖啡更危险',
        text: '火灾、债务、打架、巡查、道德批评和禁令都可能砸到店里。讽刺、宗教争论或宫廷传闻一旦被点名，你可能从低位帮工变成可替罪的转述者。',
      },
      {
        key: 'freedoms',
        label: '行动空间',
        title: '含糊、删改和沉默也是选择',
        text: '你不能决定城市政策，却能决定某句话是否被完整复述、改成笑谈、只留私人笔记或不再传播。咖啡馆给普通年轻人接近消息和表演的缝隙，也要求持续判断边界。',
      },
    ],
    timeline: [
      { year: '15世纪后期-16世纪初', title: '咖啡从红海与也门网络扩散', text: '咖啡饮用与苏菲、商旅、朝觐和红海贸易相连，逐渐进入埃及、叙利亚和奥斯曼城市生活。' },
      { year: '1550年代', title: '伊斯坦布尔早期咖啡馆兴起', text: '后世奥斯曼作者记述 1550s 前后首都出现专门咖啡馆，成为饮用、游戏、讲故事、诗歌和闲谈空间。' },
      { year: '1555-1565', title: '消息、娱乐和监管交汇', text: '咖啡馆吸引不同城市男性顾客，也引发关于浪费时间、治安、宗教规范、讽刺和政治传闻的批评。' },
      { year: '16世纪后期', title: '争议与禁令反复出现', text: '奥斯曼城市中关于咖啡馆和类似聚会空间的规训、禁令和实践调整反复出现，执行强度因时间、地点和权力关系而异。' },
      { year: '17世纪', title: '后续作者回看咖啡馆争议', text: 'Peçevi、Kâtip Çelebi 等较晚作者留下重要线索，但他们带有回忆、道德判断和后见框架。' },
    ],
    decision: {
      prompt: '夜里收店时，讲述者让你把一段尖刻讽刺和几句关于官员、禁令与宫中传闻的话整理成明天可复述的版本。你怎么处理？',
      context:
        '完整转述可能带来赏钱、名声和顾客；改写含糊能保留故事趣味但降低指向性；拒绝传播或只做私人笔记可能保护自己，却会得罪讲述者和熟客。你没有能力核实传闻，也无法预知巡查、告发或禁令执行会怎样落到店里。',
      options: [
        {
          id: 'full-retelling',
          label: '完整转述尖刻传闻',
          stance: '押注人气和赏钱',
          description: '把听到的讽刺、姓名暗示和传闻顺序尽量保留，明天交给讲述者使用。',
          immediate: '讲述者满意，熟客可能觉得你记性好、胆子大；你也可能得到小费或更稳定的助手位置。',
          longTerm: '口头笑谈一旦被写成可复述文本，追责边界更清楚。若巡查、告发或宗教/政治批评升级，你可能承担超出身份的风险。',
          reflection: '咖啡馆中的表达并非没有约束；低位帮工常在别人的名声收益和自己的追责风险之间承担信息劳动。',
        },
        {
          id: 'ambiguous-rewrite',
          label: '改写成含糊寓言再转述',
          stance: '保留故事，降低指向',
          description: '保留节奏和笑点，把具体姓名、官职和传闻改成动物寓言、远方城故事或模糊暗示。',
          immediate: '故事仍可表演，尖锐处变得可否认；讲述者可能嫌你削弱效果，也可能欣赏你的谨慎。',
          longTerm: '含糊化可能成为普通人处理监管风险的策略，但并不能消除听众解读、告发和执法任意性的危险。',
          reflection: '历史中的能动性常不是公开对抗，而是改写、绕行、双关和控制可追责性。',
        },
        {
          id: 'private-note-or-refuse',
          label: '拒绝传播，只留私人笔记',
          stance: '优先安全和来源边界',
          description: '告诉讲述者传闻无法核实，不适合明天复述；只把“有争议的话题出现过”记在自己的练字纸上。',
          immediate: '你可能失去赏钱或被说胆小，但降低了把危险话语公开扩散的风险。',
          longTerm: '私人笔记也可能被发现，但它更像学习和来源记录，而不是表演文本；你保住了继续工作的余地。',
          reflection: '拒绝传播并不等于没有观点，它是在信息不可靠和权力不对称中保护自己、承认边界的一种判断。',
        },
      ],
    },
    realHistory:
      '16 世纪中叶，咖啡和咖啡馆在奥斯曼城市中迅速引起关注。后世奥斯曼记述常把伊斯坦布尔早期咖啡馆与 Tahtakale 一带、讲故事、游戏、诗歌、新闻和闲谈联系起来，同时也记录道德批评、宗教争议和监管尝试。咖啡馆确实为城市男性社交、娱乐和消息交换提供新场所，但它们不应被直接写成现代“公共舆论”制度；更稳妥的表述是：咖啡、故事、诗歌、新闻、讽刺和传闻在这些城市空间中相遇，并被国家、宗教权威、街区关系和生计风险持续塑形。',
    interpretationNote:
      '本场景合成一名 1555-1565 年伊斯坦布尔早期咖啡馆年轻帮工/讲述者助手/抄写学徒，不对应单一可查人物。Peçevi 对早期咖啡馆的记述成书较晚，带有回忆性和道德化框架；Kâtip Çelebi 对咖啡、烟草和习俗争议的讨论同样属于后续规范辩论与学者判断；kadi court records 和城市研究更多保存精英、司法、行政或男性公共活动视角。普通帮工、女性、低位移民、非穆斯林邻里和被传闻伤害者的声音常缺席。叙事只做短摘记和转述，不复制长篇原文；所有具体对话、一天顺序和个人心理均为课堂推演。不要把 16 世纪咖啡馆直接等同于现代公共舆论空间，只能谨慎说它是消息、娱乐、争议和监管交汇的城市空间。',
    lessonPack: {
      inquiryQuestion: '早期伊斯坦布尔咖啡馆如何让普通人在谋生、表达、监管和传闻风险之间做判断？',
      quickStart: [
        '定位 1550s-1560s：伊斯坦布尔、早期咖啡馆、帮工/讲述者助手。',
        '圈出一条“消息机会”和一条“监管风险”证据。',
        '用一句话解释：为什么把口头传闻写下来会改变风险？',
      ],
      classroomFlow: {
        quick: {
          title: '12 分钟咖啡馆消息分层',
          steps: ['读身份卡与四个 scene beats', '把听到内容分为价格消息、故事表演、政治/宗教争议三类', '为每类标注“可用证据 / 待核实传闻 / 后见解释”'],
        },
        source: {
          title: '30 分钟来源边界 Source Lab',
          steps: ['比较 Peçevi、Kâtip Çelebi、kadi records 项目和现代研究的来源类型', '标出回忆性、规范判断、司法/城市精英视角和缺席声音', '写一句有边界的咖啡馆判断'],
        },
        debate: {
          title: '28 分钟转述风险听证会',
          steps: ['三组分别支持完整转述、含糊改写、拒绝传播', '每组必须引用一条场景证据和一条来源边界', '观察员指出哪种发言把现代公共舆论概念套得过满'],
        },
      },
      checkQuestions: [
        {
          question: '为什么不能把 16 世纪咖啡馆直接写成现代公共舆论空间？',
          answer: '因为咖啡馆确实聚集消息、娱乐、诗歌、讽刺和争议，但参与者、表达边界、监管机制、记录方式和政治制度都不同于现代公共舆论制度。',
          teacherNote: '要求学生使用“消息、娱乐、争议和监管交汇的城市空间”这类谨慎表述。',
        },
        {
          question: 'Peçevi 的早期咖啡馆记述有什么价值和限制？',
          answer: '它是重要奥斯曼叙述线索，可提示咖啡馆兴起和社会反应；但成书较晚，带有回忆、道德评价和后见视角，不能透明还原 1550s 某一天。',
          teacherNote: '把“有价值”与“需互证”同时保留。',
        },
        {
          question: '帮工的能动性体现在哪里？',
          answer: '不在决定禁令或城市政策，而在如何听、记、删改、含糊转述、拒绝传播和保护自己的生计名声。',
          teacherNote: '突出低位角色的小尺度判断，而非英雄式表达自由叙事。',
        },
      ],
      misconceptions: [
        { misconception: '咖啡馆出现就等于现代民主公共空间出现。', correction: '更谨慎的说法是咖啡馆成为消息、娱乐、争议和监管交汇的城市空间，不能跳到现代制度概念。' },
        { misconception: '禁令或宗教批评说明咖啡馆被完全压制。', correction: '争议和监管说明边界被持续协商；执行、例外和地方实践需要具体证据。' },
        { misconception: '传闻被抄下来就更可靠。', correction: '书写可能让内容更稳定，也可能放大追责风险；可靠性仍取决于来源、核实和传播语境。' },
      ],
      discussionRoles: [
        { role: '咖啡馆帮工/抄写学徒', task: '说明自己如何在赏钱、师承和追责风险之间选择。' },
        { role: '讲述者', task: '主张故事需要锋芒，同时回应为什么低位助手会担心。' },
        { role: '街区监管者或 kadi court 书记员', task: '说明哪些话语、打架或扰序情形可能进入记录。' },
        { role: '现代来源审查员', task: '为 Peçevi、Kâtip Çelebi、kadi records 和 scholarship 标注边界。' },
      ],
      exitTickets: [
        '写一句谨慎判断：早期伊斯坦布尔咖啡馆是____，但不是____。',
        '指出本场景最重要的一条缺席声音，并说明为什么难以补足。',
      ],
    },
    activityPacks: [
      {
        id: 'ottoman-coffeehouse-rumor-triage',
        title: '咖啡馆传闻分诊热身',
        mode: 'warmup',
        durationMinutes: 12,
        audience: '个人快速进入或两人一组',
        prompt: '把咖啡馆一天中听到的内容分成价格/码头消息、故事诗句、宗教/政治争议和街区治安四类，判断哪类最适合传播、哪类最危险。',
        materials: ['Scene Reader：咖啡香先听见码头消息', 'Scene Reader：禁令、税收和街区治安被倒进杯里', '日常切片：工作/风险/行动空间'],
        steps: ['摘出四条听来的信息。', '给每条标注“可核实 / 表演性 / 危险传闻 / 后见解释”。', '写出帮工下一步：转述、改写、沉默或求证。'],
        deliverable: '一张传闻分诊卡：信息类型 / 可用证据 / 风险 / 行动建议。',
        successCriteria: ['能区分消息、故事和传闻。', '能说明传播风险来自监管、名声或来源不明。', '不会把后世结论塞进当事人头脑。'],
        linkedSourceTitles: ['Peçevi History: early Istanbul coffeehouses', 'The Balance of Truth on coffee, tobacco and custom'],
        linkedSceneBeatTitles: ['咖啡香先听见码头消息', '禁令、税收和街区治安被倒进杯里'],
      },
      {
        id: 'ottoman-coffeehouse-source-boundary-lab',
        title: '早期咖啡馆来源边界实验室',
        mode: 'source-lab',
        durationMinutes: 32,
        audience: '四人小组史料研读',
        prompt: '比较 Peçevi、Kâtip Çelebi、Istanbul Kadı Sicilleri、Hattox、Faroqhi/Kafadar：哪些能支持咖啡馆兴起，哪些只能支持后世争议或城市生活解释？',
        materials: ['六张来源卡', '来源类型标签纸', '“事实 / 推论 / 缺席声音”矩阵'],
        steps: ['为每条来源标注 primary、institution 或 scholarship。', '写出它最能证明的一件事。', '写出它最容易造成的误读：回忆性、规范判断、精英视角或现代概念套用。', '合成一句不超过 180 字的谨慎叙事。'],
        deliverable: '一张来源边界矩阵 + 180 字谨慎咖啡馆叙事。',
        successCriteria: ['至少比较一条 primary、一条 institution 和一条 scholarship 来源。', '明确标出回忆性/规范性/后见性限制。', '结论避免现代公共舆论直套。'],
        linkedSourceTitles: ['Peçevi History: early Istanbul coffeehouses', 'The Balance of Truth on coffee, tobacco and custom', 'Istanbul Kadı Sicilleri / Ottoman court records project', 'Coffee and Coffeehouses: The Origins of a Social Beverage in the Medieval Near East'],
        linkedSceneBeatTitles: ['故事、诗句和新闻同桌', '禁令、税收和街区治安被倒进杯里'],
      },
      {
        id: 'ottoman-coffeehouse-dangerous-retelling-roleplay',
        title: '危险传闻转述听证会',
        mode: 'roleplay',
        durationMinutes: 28,
        audience: '三到五人角色扮演或课堂辩论',
        prompt: '围绕夜间讽刺传闻，帮工、讲述者、店主、监管者和熟客分别说明该完整转述、含糊改写还是拒绝传播。',
        materials: ['决策选项卡', 'Scene Reader：危险传闻要不要落到纸上', 'discussion roles', '来源边界提示'],
        steps: ['每人抽取一个角色并写出目标和风险。', '轮流用 45 秒说明建议。', '记录每种选择的即时收益、长期风险和来源边界。', '全组形成一份最终转述原则。'],
        deliverable: '一份咖啡馆转述原则：可转述、需改写、应沉默、仍不确定。',
        successCriteria: ['角色发言符合身份资源和限制。', '能把口头和书写的风险区分开。', '至少引用一条来源限制而非只做价值判断。'],
        linkedSourceTitles: ['Peçevi History: early Istanbul coffeehouses', 'A History of Coffee', 'Istanbul Kadı Sicilleri / Ottoman court records project'],
        linkedSceneBeatTitles: ['危险传闻要不要落到纸上', '禁令、税收和街区治安被倒进杯里'],
      },
    ],
    missions: [
      {
        id: 'ottoman-map-coffeehouse-message-flow',
        title: '绘制咖啡馆消息流',
        instruction: '把码头、市集、讲述者、顾客、帮工和监管者连成一条“消息—转述—风险”路径。',
        evidenceUse: '使用清晨码头消息、午后故事新闻、夜间抄写 scene beats 和至少两条来源卡。',
        deliverable: '一张 5 节点消息流图，附 120 字说明：哪里最容易失真或被追责？',
        estimatedMinutes: 18,
        difficulty: '入门',
        taskType: '因果链',
        steps: ['列出 5 个消息节点。', '为每个节点标注媒介：口头、表演、抄写、司法记录或后世研究。', '指出一个失真点和一个追责点。'],
        evidenceChecklist: ['包含码头/市场消息。', '包含讲述者或诗歌表演。', '包含抄写或监管风险。', '至少点名两条来源。'],
        reflectionPrompt: '为什么消息流动得更快并不等于普通人更安全？',
        outputTemplate: ['节点一：', '节点二：', '媒介变化：', '失真风险：', '追责风险：', '谨慎结论：'],
        rubric: ['链条结构清楚。', '能区分口头、书写和后世来源。', '至少使用三条场景/来源证据。', '结论承认信息不完整。'],
        sentenceStarters: ['消息最先来自……', '它通过……被重新包装。', '最容易失真的地方是……', '对帮工来说，风险在于……'],
        linkedSourceTitles: ['Peçevi History: early Istanbul coffeehouses', 'Coffee and Coffeehouses: The Origins of a Social Beverage in the Medieval Near East'],
      },
      {
        id: 'ottoman-judge-retelling-choice',
        title: '判断是否转述危险传闻',
        instruction: '站在咖啡馆帮工位置，在完整转述、含糊改写、拒绝传播之间选择，并说明收益、风险和来源边界。',
        evidenceUse: '使用决策选项、夜间抄写 scene beat、日常风险/行动空间切片和 Peçevi / Kâtip Çelebi 来源边界。',
        deliverable: '一张 170 字角色判断卡：我会____，因为____；但我不能确定____。',
        estimatedMinutes: 22,
        difficulty: '进阶',
        taskType: '角色判断',
        steps: ['选择一个行动。', '写出它保护的对象：生计、名声、故事效果、店主安全或来源可靠性。', '用三条证据说明选择为何受限。', '写出一条不能由现有来源证明的个人心理。'],
        evidenceChecklist: ['区分口头传闻和书面记录。', '提到监管、宗教批评或治安风险。', '包含一条来源可靠性说明。'],
        reflectionPrompt: '低位角色的“表达”为什么常表现为删改、含糊或沉默？',
        outputTemplate: ['我的选择：', '即时收益：', '长期风险：', '支持证据：', '不能确定：', '边界结论：'],
        rubric: ['判断符合帮工身份和信息限制。', '收益与风险权衡完整。', '至少引用三条证据。', '避免现代自由表达概念直套。'],
        sentenceStarters: ['站在帮工的位置，我会……', '这个选择短期保护……', '但长期可能……', '来源只能说明……不能说明……'],
        linkedSourceTitles: ['Peçevi History: early Istanbul coffeehouses', 'The Balance of Truth on coffee, tobacco and custom', 'A History of Coffee'],
      },
      {
        id: 'ottoman-source-public-space-caution',
        title: '校准“公共空间”说法',
        instruction: '说明为什么早期咖啡馆可以被称为消息、娱乐、争议和监管交汇的城市空间，但不能直接等同于现代公共舆论空间。',
        evidenceUse: '比较 Peçevi、Kâtip Çelebi、Istanbul Kadı Sicilleri、Hattox 和 Faroqhi/Kafadar 的证据层级。',
        deliverable: '一张史料判断卡：可说 / 不能说 / 还需证据 / 缺席声音。',
        estimatedMinutes: 30,
        difficulty: '挑战',
        taskType: '史料判断',
        steps: ['选择至少四条不同类型来源。', '写出它们共同支持的谨慎判断。', '列出“现代公共舆论”直套会造成的两个误读。', '指出普通帮工、女性或低位顾客声音为何缺席。'],
        evidenceChecklist: ['至少包含一条 primary、一条 institution、一条 scholarship 来源。', '明确写出“回忆性/规范判断/后见视角/精英记录”至少两项限制。', '包含谨慎替代表述。'],
        reflectionPrompt: '历史解释为什么需要保留“像什么”和“不等于什么”两个层次？',
        outputTemplate: ['可谨慎说：', '不能直接说：', '支持来源：', '来源限制：', '缺席声音：', '替代表述：'],
        rubric: ['来源类型判断准确。', '能区分证据支持与概念外推。', '明确指出缺席声音。', '结论语言谨慎、可被证据支撑。'],
        sentenceStarters: ['现有证据可以支持……', '但不能直接推出……', '这条来源需要谨慎，因为……', '更稳妥的表述是……'],
        linkedSourceTitles: ['Peçevi History: early Istanbul coffeehouses', 'The Balance of Truth on coffee, tobacco and custom', 'Istanbul Kadı Sicilleri / Ottoman court records project', 'Subjects of the Sultan: Culture and Daily Life in the Ottoman Empire'],
      },
    ],
    socialActors: [
      {
        id: 'self',
        name: '年轻咖啡馆帮工',
        role: '煮咖啡、跑腿、听记故事与抄写短札',
        relationship: '核心决策者；靠店主和讲述者给活，也直接承担传错话、写错话或被追责的风险。',
        goals: '保住工钱、学会识字和表演技巧、扩大熟客关系，同时不把自己卷入危险传闻。',
        constraints: '年龄低、身份低、收入少，无法核实多数政治/宗教传闻，也不能公开违抗店主或讲述者。',
        knowledgeLimits: '只能听见码头、市集和咖啡馆里的片段消息；不知道禁令执行强度、告发路线或后世结局。',
        risksOrStakes: '失去工钱、被赶出街区、卷入治安/宗教批评记录，或在熟客圈失去可信度。',
        likelyViewOfDecision: '倾向选择含糊改写或私人笔记，在保留生计机会的同时降低可追责性。',
        evidenceLinks: ['危险传闻要不要落到纸上', '日常切片：风险', '决策选项'],
      },
      {
        id: 'storyteller',
        name: '咖啡馆讲述者',
        role: '讲故事、吟诗、组织笑话和时事段子的表演者',
        relationship: '给帮工学习和赏钱机会，也把锋利内容交给帮工整理。',
        goals: '吸引顾客、维持名声、让故事显得新鲜大胆。',
        constraints: '依赖店主许可、顾客打赏和街区容忍；太尖锐会引来投诉或监管。',
        knowledgeLimits: '熟悉表演效果，但未必能核实每条传闻，也可能低估低位助手承担的风险。',
        risksOrStakes: '表演失去吸引力会影响收入；被指控扰乱秩序或传播不当言论会损害名声。',
        likelyViewOfDecision: '可能偏向完整转述或巧妙含糊化，反对完全拒绝传播。',
        evidenceLinks: ['故事、诗句和新闻同桌', '危险传闻要不要落到纸上'],
      },
      {
        id: 'shopkeeper',
        name: '咖啡馆店主',
        role: '经营者、雇主和街区关系协调者',
        relationship: '雇用帮工，控制店内规则，也要面对税、检查、邻里和顾客。',
        goals: '维持客流、避免打架和巡查麻烦、保护店的长期生意。',
        constraints: '受税费、禁令、街区名声、宗教/道德批评和顾客需求夹击。',
        knowledgeLimits: '知道生意账和熟客性格，但不一定能预测政策变化或外部告发。',
        risksOrStakes: '店被罚、被关、失去顾客或卷入官司。',
        likelyViewOfDecision: '支持改写含糊或不落纸，除非确定内容只会带来生意而不会惹祸。',
        evidenceLinks: ['禁令、税收和街区治安被倒进杯里', 'Istanbul Kadı Sicilleri / Ottoman court records project'],
      },
      {
        id: 'regulator',
        name: '街区监管者 / kadi court 书记员',
        role: '治安、司法或规范秩序的记录与执行人员',
        relationship: '不一定常在店里，却能通过巡查、投诉或记录改变咖啡馆边界。',
        goals: '减少扰序、打架、可追责言论和上级认为失控的聚会。',
        constraints: '受上级命令、地方执行资源、街区关系和规范文本限制。',
        knowledgeLimits: '看到的是投诉、记录和秩序问题，不一定能理解咖啡馆日常生计和表演语境。',
        risksOrStakes: '若放任争议，可能被认为失职；若执法过强，也可能激化街区和商户不满。',
        likelyViewOfDecision: '倾向反对具体指名、可扩散和可记录的危险传闻。',
        evidenceLinks: ['The Balance of Truth on coffee, tobacco and custom', 'Istanbul Kadı Sicilleri / Ottoman court records project'],
      },
    ],
    socialEncounters: [
      {
        id: 'night-retelling-negotiation',
        title: '夜间转述协商',
        setting: '收店后的咖啡馆后间，讲述者、店主和年轻帮工围着折纸讨论明天是否复述。',
        decisionFocus: '谁能从尖刻故事中获益，谁承担被记录、告发或失去生计的风险？',
        actorIds: ['self', 'storyteller', 'shopkeeper', 'regulator'],
        tension: '讲述者追求人气，店主追求生意安全，帮工追求学习和生计，监管者视角则把同一段话看成秩序风险。',
        evidenceLinks: ['危险传闻要不要落到纸上', '决策选项', '来源层'],
        taskChecklist: ['选择至少两位行动者比较立场', '标出每位行动者的收益与风险', '区分口头笑谈和书写文本', '引用一条来源可靠性边界', '形成一条转述原则'],
      },
      {
        id: 'market-news-morning-round',
        title: '清晨码头消息圆桌',
        setting: 'Tahtakale 附近店门初开，搬夫、商贩、熟客和帮工把价格、船期和禁令传闻带进店里。',
        decisionFocus: '哪些消息可以用来安排生意，哪些只适合作为待核实的谈资？',
        actorIds: ['self', 'shopkeeper', 'storyteller'],
        tension: '同一条消息对店主是生意信号，对讲述者是段子素材，对帮工则是学习机会和传错话风险。',
        evidenceLinks: ['咖啡香先听见码头消息', '故事、诗句和新闻同桌'],
        taskChecklist: ['列出三类消息', '标注消息来源和媒介', '判断哪类消息最容易失真', '说明低位帮工如何求证或含糊处理'],
      },
    ],
    materialObjects: [
      {
        id: 'ottoman-coffeehouse-cezve-cups',
        name: '铜咖啡壶与小杯',
        category: 'serving object',
        shortLabel: 'cezve 与 fincan',
        description: '铜壶、小杯和托盘把也门/红海贸易中的咖啡变成伊斯坦布尔街区可购买、可聚会、可争议的饮品。',
        objectBiography: '咖啡豆经贸易网络抵达首都，在店内被烘、磨、煮、端上桌；器物本身多为日常消耗品，未必作为单件文物留下。',
        everydayUse: '帮工用它控制火候、续杯、记桌位和维持顾客停留节奏。',
        laborOrSkill: '显示煮咖啡、判断火候、服务客人和听取消息的复合劳动。',
        exchangeOrPower: '小杯延长了顾客停留，也让店主、讲述者、熟客和监管者围绕同一空间重新分配注意力和风险。',
        evidenceLimit: '器物能提示饮用和聚会实践，但不能单独证明某一条传闻、某次禁令执行或帮工个人经历。',
        linkedSourceTitles: ['Coffee and Coffeehouses: The Origins of a Social Beverage in the Medieval Near East', 'Peçevi History: early Istanbul coffeehouses'],
        linkedSceneBeatTitles: ['咖啡香先听见码头消息', '故事、诗句和新闻同桌'],
        inquiryPrompts: ['这件器物如何把商品流动变成社交空间？', '谁控制它的使用节奏，谁从停留中获益？', '如果只看器物，哪些言语和风险会消失？'],
        tags: ['material culture', 'coffee', 'serving vessel', 'urban sociability', 'trade'],
      },
      {
        id: 'ottoman-coffeehouse-story-scrap',
        name: '折纸短札与练字纸',
        category: 'record object',
        shortLabel: '传闻短札',
        description: '一张写着诗句、笑话梗概或传闻提示的纸片，帮助讲述者复述，也把含糊口头内容变成较可追责的痕迹。',
        objectBiography: '纸片可能来自旧账边角、练字纸或客人短札；它在口袋、柜台和后间之间流动，通常不会被正式保存。',
        everydayUse: '帮工用它练字、记顺序、摘关键词，或提醒自己哪些话不该公开复述。',
        laborOrSkill: '显示低位助手的识字、删改、记忆和风险判断劳动。',
        exchangeOrPower: '书写让故事更容易复制，也让责任更容易被追踪；谁拥有纸片，谁就可能拥有证据或麻烦。',
        evidenceLimit: '本物件为教学重构；现有来源很少保存普通帮工的纸片，因此只能作为口头/书写边界的分析工具。',
        linkedSourceTitles: ['A History of Coffee', 'Istanbul Kadı Sicilleri / Ottoman court records project'],
        linkedSceneBeatTitles: ['危险传闻要不要落到纸上', '禁令、税收和街区治安被倒进杯里'],
        inquiryPrompts: ['书写如何改变传闻的风险？', '纸片能证明说过什么，还是只能证明有人准备转述？', '普通帮工的纸为何难以进入档案？'],
        tags: ['material culture', 'writing', 'rumor', 'source limits', 'accountability'],
      },
      {
        id: 'ottoman-coffeehouse-roasted-beans',
        name: '烘咖啡豆与研钵',
        category: 'exchange object',
        shortLabel: '烘豆与研钵',
        description: '烘豆和研钵把远距离商品、店内体力劳动和顾客等待连在一起。',
        objectBiography: '咖啡豆从红海/也门等网络进入奥斯曼城市，再被分装、烘烤、研磨和煮成杯中饮品。',
        everydayUse: '清晨准备、补货和火候判断都围绕它展开，是帮工一天开始的物质节奏。',
        laborOrSkill: '需要辨认豆况、控制烘焙、研磨粗细和节省成本。',
        exchangeOrPower: '豆价、供应和税费会影响店主利润、顾客价格和帮工工作强度。',
        evidenceLimit: '能支持咖啡贸易与店内劳动的关系，但不能推断具体供应量、价格或每家店实践。',
        linkedSourceTitles: ['Coffee and Coffeehouses: The Origins of a Social Beverage in the Medieval Near East', 'Subjects of the Sultan: Culture and Daily Life in the Ottoman Empire'],
        linkedSceneBeatTitles: ['咖啡香先听见码头消息', '禁令、税收和街区治安被倒进杯里'],
        inquiryPrompts: ['咖啡豆如何把红海贸易和伊斯坦布尔街区连接起来？', '供应不稳会先影响谁？', '商品证据和言论证据应如何并读？'],
        tags: ['material culture', 'coffee beans', 'trade', 'labor', 'Ottoman Istanbul'],
      },
    ],
    keyTerms: [
      { term: 'kahvehane', definition: '奥斯曼土耳其语中咖啡馆/咖啡屋的称呼，16 世纪中叶后在城市社交、娱乐和争议中越来越显眼。' },
      { term: 'Tahtakale', definition: '伊斯坦布尔商业街区之一，后世记述常把早期咖啡馆兴起与这一带的市场和码头环境相连。' },
      { term: 'mukaddime / meddah', definition: '此处泛指讲述者和表演传统；故事、笑话、诗句和时事暗示可能在咖啡馆中交织。' },
      { term: 'kadi court', definition: '奥斯曼伊斯兰法官法庭及其记录体系，可保存诉讼、秩序、商业和社区纠纷线索，但多为司法/行政视角。' },
      { term: 'fetva / norm debate', definition: '关于咖啡、烟草或习俗是否可接受的法学和道德争论；它反映规范判断，不等同于日常实践全貌。' },
      { term: 'oral rumor', definition: '通过口耳相传、表演、客人闲谈扩散的未核实消息；可影响行动，但必须与事实证据区分。' },
      { term: 'retrospective source', definition: '较晚作者回看早期事件的材料，可能保存重要记忆，也带有后见、选择和道德评价。' },
      { term: 'public life', definition: '城市中超出家庭的社交、交易、娱乐和争议活动；用于 16 世纪咖啡馆时需避免直接等同现代公共舆论制度。' },
    ],
    compareAngles: [
      { title: '咖啡馆 vs. 茶铺', prompt: '伊斯坦布尔咖啡馆和汴京茶铺都让消息进入日常劳动，但它们面对的监管、来源边界和城市制度有何不同？' },
      { title: '口头传闻 vs. 书写记录', prompt: '咖啡馆短札、Fustat 商人书信和 Inca khipu 都让信息可携带，但各自如何改变可靠性和追责风险？' },
      { title: '城市社交 vs. 城市秩序', prompt: '为什么同一处热闹空间既能创造机会，也会引发道德批评、治安担忧和制度监管？' },
      { title: '现代概念 vs. 谨慎解释', prompt: '当我们想使用“公共空间”或“舆论”时，哪些证据支持，哪些差异要求我们收窄表述？' },
    ],
    sourceEvidenceUse:
      '先用 Peçevi 的早期咖啡馆记述作为重要但回忆性的 primary 线索，提示 1550s 伊斯坦布尔咖啡馆兴起、顾客活动和社会反应；再用 Kâtip Çelebi 关于咖啡、烟草和习俗争议的文本理解后续规范辩论，而不是直接还原现场；用 Istanbul Kadı Sicilleri / Ottoman court records 项目提示司法和城市秩序记录能保存哪些纠纷、监管和街区关系，也会过滤普通帮工和非正式谈话；用 Hattox 校准咖啡传播与咖啡馆起源，用 Faroqhi 与 Kafadar 等城市/日常/公共生活研究约束“公共空间”概念。所有来源只作短摘记/转述，避免长篇版权原文；结论必须标注回忆性、规范性、后见视角、城市精英记录和缺席声音。',
    sources: [
      {
        title: 'Peçevi History: early Istanbul coffeehouses',
        creator: 'İbrahim Peçevi',
        sourceType: 'primary',
        relevance: '后世奥斯曼史家关于伊斯坦布尔早期咖啡馆的著名记述，常被用来讨论 1550s 首都咖啡馆兴起和社会反应。',
        excerpt: '记述把咖啡馆兴起、顾客聚集、闲谈、阅读、游戏和批评声音联系起来，是理解早期咖啡馆形象的重要线索。',
        sourceQuestion: '这段较晚回忆能支持哪些关于咖啡馆活动和争议的判断？哪些细节不能直接当作 1550s 现场记录？',
        reliabilityNote: '成书较晚，带有回忆性、选择性和道德评价；适合作为早期咖啡馆形象线索，不能单独证明具体帮工、某日对话或执行细节。',
        perspective: '17 世纪奥斯曼史家回顾首都社会风俗与道德争议的视角',
        evidenceTags: ['coffeehouse', 'retrospective source', 'urban sociability', 'rumor', 'source limits'],
      },
      {
        title: 'The Balance of Truth on coffee, tobacco and custom',
        creator: 'Kâtip Çelebi',
        sourceType: 'primary',
        relevance: 'Kâtip Çelebi 对咖啡、烟草、习俗和宗教/法律争议的讨论，有助于理解咖啡馆相关规范辩论。',
        excerpt: '文本围绕新习俗、争议与判断展开，提示咖啡并非单纯饮品，也被纳入道德、法学和秩序讨论。',
        sourceQuestion: '规范辩论能说明争议边界，但能否说明普通咖啡馆每天如何执行或规避？',
        reliabilityNote: '学者规范论述带有立场、论辩目的和后续视角；不能把其判断直接等同于街头实践或所有人的看法。',
        perspective: '17 世纪奥斯曼学者、百科式作者和规范辩论视角',
        evidenceTags: ['coffee controversy', 'normative debate', 'religious criticism', 'custom', 'regulation'],
      },
      {
        title: 'Istanbul Kadı Sicilleri / Ottoman court records project',
        creator: 'İSAM and Istanbul court records editors',
        sourceType: 'institution',
        relevance: '伊斯坦布尔法庭记录项目提供城市司法、商业、街区和秩序记录入口，可训练学生理解制度记录能看见什么。',
        excerpt: 'kadi records 保存诉讼、交易、街区纠纷和秩序问题等线索，但通常在事件进入司法/行政处理时才留下痕迹。',
        sourceQuestion: '法庭记录能看见咖啡馆相关纠纷、税费或治安问题吗？它为何难以保存普通闲谈和低位帮工声音？',
        reliabilityNote: '机构整理材料适合展示记录类型和城市治理线索；但记录受诉讼、抄录、保存和精英行政语言过滤。',
        perspective: '现代机构整理的奥斯曼司法档案与城市治理视角',
        evidenceTags: ['kadi records', 'institution source', 'urban order', 'legal record', 'absent voices'],
        url: 'https://kadisicilleri.org/',
      },
      {
        title: 'Coffee and Coffeehouses: The Origins of a Social Beverage in the Medieval Near East',
        creator: 'Ralph S. Hattox',
        sourceType: 'scholarship',
        relevance: '研究咖啡作为饮品和咖啡馆作为社交空间在中东和奥斯曼语境中的形成，是本场景咖啡传播和争议背景的核心 scholarship。',
        excerpt: '研究把咖啡传播、苏菲实践、城市社交、道德批评和禁令争议放在同一历史脉络中。',
        sourceQuestion: '咖啡馆起源研究如何帮助我们避免把饮品、空间和社会争议割裂开？',
        reliabilityNote: '权威综合研究可校准宏观背景；具体伊斯坦布尔帮工的一天仍是教学合成，需要与 primary 线索和城市研究并读。',
        perspective: '现代中东咖啡史与社会文化史视角',
        evidenceTags: ['coffee', 'coffeehouses', 'social beverage', 'regulation', 'Ottoman cities'],
      },
      {
        title: 'Subjects of the Sultan: Culture and Daily Life in the Ottoman Empire',
        creator: 'Suraiya Faroqhi',
        sourceType: 'scholarship',
        relevance: '提供奥斯曼城市日常生活、物质文化、普通臣民和制度环境的研究框架，帮助把咖啡馆放入更广阔城市生活中。',
        excerpt: '研究强调奥斯曼普通生活受家庭、市场、国家、宗教和物质条件共同塑形。',
        sourceQuestion: '日常生活研究怎样帮助我们把咖啡馆从“奇特新饮品”扩展到劳动、消费和城市秩序？',
        reliabilityNote: '现代综合能帮助构建背景，但普通帮工、女性和低位移民细节仍需谨慎推论。',
        perspective: '现代奥斯曼日常生活与社会史视角',
        evidenceTags: ['daily life', 'Ottoman society', 'urban life', 'ordinary people', 'source limits'],
      },
      {
        title: 'A History of Coffee',
        creator: 'Cemal Kafadar',
        sourceType: 'scholarship',
        relevance: '围绕奥斯曼咖啡、咖啡馆和城市公共生活的研究与讲述，适合校准“社交空间/公共生活”而非现代公共舆论的表述。',
        excerpt: '研究把咖啡馆放在社交、故事、文本、权力和城市文化交汇处，提醒读者关注后世记述与概念边界。',
        sourceQuestion: '我们能如何使用“public life”而不把现代公共 sphere 概念直接倒推到 16 世纪？',
        reliabilityNote: '现代解释有助于概念校准；课堂使用时应避免把 scholarship 的分析框架写成当时普通人自觉拥有的政治语言。',
        perspective: '现代奥斯曼文化史、城市公共生活和解释史视角',
        evidenceTags: ['public life', 'coffeehouse culture', 'interpretation', 'urban culture', 'anachronism risk'],
      },
    ],
  },
  {
    id: 'tokugawa-osaka-dojima-rice-ledger-apprentice',
    title: '德川大阪堂岛米市账房学徒的一天',
    era: '约 1730 年德川日本城市商业成长与米市场制度化时期',
    year: 1730,
    location: '日本大阪堂岛米市 / 藩仓与米商账房之间',
    region: '日本 / 畿内大阪',
    coordinates: [34.6937, 135.5023],
    identity: '大阪米商铺中的账房学徒、米票记录助手和跑腿传信人',
    role: '核对藏米、米票、账本与报价消息，在米商、经纪、武士俸禄代理和监管者之间传递短笺',
    age: 16,
    theme: '德川城市商业、堂岛米市、藩仓米、武士俸禄货币化、米票信用、价格传闻、账本责任和幕府监管',
    accent: '#9b6a32',
    summary:
      '你在大阪堂岛附近一家米商铺做账房学徒。清晨你核对藩仓寄来的藏米记录与米票，午前带着价格短笺穿过桥边店铺，午后传闻说某地收成或幕府监管将改变报价，夜里资深账房要求你重算一整日记录。米既是田地收成、武士俸禄、城市商品，也是纸面承诺；你握着笔和跑腿脚力，却承担误记、迟报、传闻和替上位者背责的风险。',
    atmosphere:
      '堂岛水边的湿气混着稻米、墨、木算盘和油灯味。仓门未开，纸上的米票已经先在人手中流转；武士代理急着把俸米换成银钱，商人盯着报价，跑腿小童在桥与账房之间穿梭。每一笔看似只是数字，却把远处仓米、藩财政、商人信用、市场传闻和幕府眼光压进薄薄账页。',
    sceneBeats: [
      {
        timeLabel: '清晨开账',
        title: '藏米未动，米票先被核对',
        sensoryDetail: '晨雾还贴着堂岛川，账房里算盘珠噼啪作响。你把藩仓来的藏米数、昨日未结米票和今日经纪人名册并排，墨迹未干就有人催问可卖多少。',
        historicalTension: '堂岛米市让实物米、仓储凭据和未来交割承诺分离；账本能把远处仓米变成交易对象，也让低位助手承担抄错、漏记或混淆实物与票据的风险。',
        evidenceHook: '用大阪交易所/堂岛历史材料和现代研究区分实物米、仓单/米票、信用承诺与后世“期货市场”解释。',
        learnerPrompt: '为什么“仓里有米”和“手里有米票”不是同一件事？请写出账本能证明与不能证明的内容。',
        linkedDailyLifeKeys: ['work', 'education', 'risks'],
        linkedSourceTitles: ['Osaka Exchange: History of Dojima Rice Exchange', 'The Evolution of Futures Trading: From Japanese Rice Markets to Modern Exchanges'],
      },
      {
        timeLabel: '午前跑腿',
        title: '桥上短笺比脚步更快',
        sensoryDetail: '你把折起的价格短笺塞进袖口，穿过桥边米商、茶摊和经纪人门口。木屐敲在湿石上，身后有人低声问今天某藩米票是否还稳。',
        historicalTension: '价格消息的速度影响交易信任；跑腿人不是市场主角，却把报价、传闻和责任从一个账房带到另一个账房。',
        evidenceHook: '把城市商业研究与堂岛制度史并读，观察商人信用、经纪网络和消息流如何让市场运行。',
        learnerPrompt: '如果消息比正式文书先到，跑腿传信人如何既有价值又危险？',
        linkedDailyLifeKeys: ['work', 'risks', 'freedoms'],
        linkedSourceTitles: ['Osaka Museum of History materials on Osaka as tenka no daidokoro', 'Merchants and Society in Tokugawa Japan'],
      },
      {
        timeLabel: '午后传闻',
        title: '一句收成传闻摇动报价',
        sensoryDetail: '午后空气闷热，账房外忽然挤满低声交谈的人。有人说北国收成欠佳，有人说幕府会盯紧投机，报价牌旁的手指停了又动。',
        historicalTension: '天候、收成、藩财政、武士俸禄现金化和监管消息都会改变米价预期；传闻可能是风险预警，也可能诱发错误报价和追责。',
        evidenceHook: '用 Bank of Japan Currency Museum 与德川经济研究材料说明米、银钱和信用的关系，同时避免编造具体米价或成交量。',
        learnerPrompt: '面对无法核实的收成/监管传闻，哪些信息是当时可知，哪些只是后见解释？',
        linkedDailyLifeKeys: ['food', 'work', 'risks'],
        linkedSourceTitles: ['Bank of Japan Currency Museum: money and early modern Japan', 'Tokugawa bakufu and Osaka rice market regulatory records'],
      },
      {
        timeLabel: '夜里重算',
        title: '油灯下，错误要有名字',
        sensoryDetail: '油灯芯烧出焦味，资深账房把白天票据摊开，要你按经纪人、仓米、票面和传信时刻重抄一遍。门外水声很轻，屋内每个错字都很响。',
        historicalTension: '账本建立信用，也制造责任链。低位学徒能接触关键信息，却很难决定报价或政策；一旦账目不合，误记、迟报和传闻责任可能落到最容易替换的人身上。',
        evidenceHook: '用商人信用与城市社会研究讨论账簿作为证据和权力工具，并标注普通学徒、搬运工、家庭成员直接声音稀少。',
        learnerPrompt: '账本在什么意义上保护交易？又在什么意义上把责任向下推？',
        linkedDailyLifeKeys: ['education', 'work', 'risks', 'freedoms'],
        linkedSourceTitles: ['Merchants and Society in Tokugawa Japan', 'The Evolution of Futures Trading: From Japanese Rice Markets to Modern Exchanges'],
      },
    ],
    dailyLife: [
      {
        ...
        label: '饮食',
        title: '吃米的人也被米价牵动',
        text: '你能吃到米饭、麦饭、腌菜、味噌汤或小鱼，伙食取决于店铺、家中补贴和城市物价。米价上涨不只是账房数字，也会改变普通人的饭碗、欠账和雇主脾气。',
      },
      {
        key: 'home',
        label: '居所',
        title: '铺里睡席与远处家计',
        text: '你多半住在商铺后间或学徒铺位，家可能在大阪町中或近郊。你把工资、饭食、学艺机会和家中期待绑在店铺信誉上，夜里听见河岸装卸声也很难真正下工。',
      },
      {
        key: 'work',
        label: '工作',
        title: '算盘、账页、短笺和木屐',
        text: '工作包括抄写米票编号、核对仓米记录、递送报价、给资深账房磨墨、听经纪人报数、跑到仓边或桥边传话。你处理的是纸上承诺，却必须用脚、耳朵和记忆维持速度。',
      },
      {
        key: 'education',
        label: '学习',
        title: '在错误中学会信用语言',
        text: '你学习算盘、商家书札、米票格式、敬语、经纪称呼和账本分类。教育不是学校式课程，而是在被纠错、被催促和观察资深账房如何判断消息真伪中完成。',
      },
      {
        key: 'risks',
        label: '风险',
        title: '误记、迟报、传闻和替罪',
        text: '风险来自抄错数目、漏传报价、误把传闻当正式消息、得罪经纪或武士代理、卷入价格波动和监管调查。你地位低，知道许多消息，却缺少解释失败的权力。',
      },
      {
        key: 'freedoms',
        label: '行动空间',
        title: '速度与谨慎之间的小选择',
        text: '你不能决定市场规则或藩财政，但能选择先向谁求证、如何标注未核消息、是否提醒资深账房票据异常、跑腿时听哪些人的话。你的能动性集中在速度、谨慎和关系维护之间。',
      },
    ],
    timeline: [
      { year: '17 世纪', title: '德川城市商业与大阪地位上升', text: '江户、京都、大阪等城市成长，大阪因仓储、批发、金融和运输功能被称为“天下厨房”。米、银钱、手工业品和商人信用共同支撑城市经济。' },
      { year: '17-18 世纪', title: '藩仓米与武士俸禄货币化', text: '许多藩把年贡米运到大阪仓库，再通过商人出售或抵押以筹措现金；武士俸禄以米计量，却常需要转化为银钱来支付城市生活和藩财政开支。' },
      { year: '约 1710-1730', title: '堂岛米市制度化与监管关注', text: '堂岛一带的米交易、经纪、账本和票据逐步形成制度化市场。幕府和城市当局既需要市场流通，也担心投机、价格波动和社会秩序。' },
      { year: '约 1730', title: '米票、报价和传闻交织的一天', text: '本场景设在堂岛米市成熟化的教学时刻：仓米、米票、远期承诺、价格消息和监管传闻交织。不要把它写成现代证券交易所的完整等价物。' },
      { year: '18 世纪', title: '天候收成与价格波动反复影响城市', text: '歉收、丰收、运输、藩财政和消费需求会改变米价；价格波动不只影响商人，也影响武士收入、市民饭食和政治稳定。' },
      { year: '后世解释', title: '经济史中的堂岛与解释边界', text: '后世常把堂岛米市视为早期有组织期货交易的重要案例，但课堂使用必须区分当时制度、后世金融概念和幸存来源，避免编造具体米价、成交量或个人账本。' },
    ],
    decision: {
      prompt: '午后传来消息：某藩仓米可能短缺，另有人说幕府会查问过度投机。资深账房外出未归，门口经纪催你把今日报价和米票记录先写进临时账。你怎么处理？',
      context:
        '如果立刻按传闻修正报价或账本，店铺可能抢先避险，也可能把未核消息写成事实；如果等待正式消息，账面更稳，却可能被说迟报、错失交易或隐瞒风险；如果去找资深账房或可靠经纪求证，会牺牲速度，但能把责任和证据链写清。你只是学徒，必须在速度、信用和追责之间做低位判断。',
      options: [
        {
          id: 'change-ledger-on-rumor',
          label: '立刻按传闻修正账本/报价',
          stance: '速度优先，先替店铺避险',
          description: '把传闻当作暂时依据，调整临时报价并在账边做简短记号，等资深账房回来再解释。',
          immediate: '店铺可能比旁人更快反应，少接风险票据；但你把未核消息写进账面，若传闻错误，最先被追问的可能是你。',
          longTerm: '如果判断碰巧正确，你会被看成机敏；如果引发错价或争议，账本会把你的笔迹留成责任证据，损害学徒信誉。',
          reflection: '市场中的“快”不是单纯优点；当纸面记录制造信用时，未经核实的速度也会制造可追责的错误。',
        },
        {
          id: 'wait-for-official-message',
          label: '等待正式消息，冒迟报风险',
          stance: '可靠性优先，不把传闻写成事实',
          description: '维持原账，只在另纸记下传闻来源和时间，等藩仓、经纪会所或资深账房给出更正式消息后再改。',
          immediate: '账本暂时清楚，未把传闻变成报价；但经纪可能责怪你慢，店铺若错过行情，你会被说成迟钝或胆小。',
          longTerm: '你维护了账本可信度，也可能建立谨慎名声；但在价格剧烈波动时，过慢同样会伤害店铺关系和未来学徒机会。',
          reflection: '信用依赖可靠记录，但市场也惩罚迟缓。低位记录者常在两种错误之间选择，而不是在正确与错误之间自由选择。',
        },
        {
          id: 'verify-with-senior-or-broker',
          label: '向资深账房或经纪求证',
          stance: '牺牲速度，换取可追溯责任链',
          description: '先跑去找资深账房、可靠经纪或仓边熟人核对，并把“谁说、何时说、是否确认”写在临时札上。',
          immediate: '你会比立刻改账慢，可能被催促；但一旦消息被确认或否定，账房能知道依据来自哪里，责任不只落在你的记忆上。',
          longTerm: '你练习把信用建立在可追溯消息链上，可能赢得资深账房信任；但若求证对象不可靠，或错过关键报价，仍会承担部分责任。',
          reflection: '求证不是消除风险，而是把风险从个人猜测转为可讨论的证据链；这正是账本和信用制度的双重作用。',
        },
      ],
    },
    realHistory:
      '德川时期大阪是日本重要的仓储、批发和金融城市，常被称为“天下厨房”。各藩年贡米和武士俸禄以米为核心计量，但城市财政和消费需要把米转化为银钱、票据和信用安排。堂岛米市在 18 世纪形成有组织的米交易、经纪、票据和结算制度，常被经济史讨论为早期期货交易的重要案例。米在这里同时是实物粮食、财政基础、俸禄尺度、市场商品和信用承诺。价格受收成、运输、藩财政、消费需求、传闻和监管影响；幕府既依赖米市场流通，也担心投机与价格波动影响社会秩序。本场景不提供具体米价、成交量或某个账房的真实日记，而用合成学徒身份帮助理解信用制度如何落到低位记录劳动上。',
    interpretationNote:
      '本场景合成一名约 1730 年大阪堂岛米商铺中的账房学徒 / 米票记录助手 / 跑腿传信人，不对应单一可查人物。堂岛常被后世经济史称为早期期货市场的重要案例，但不能把它直接等同现代金融市场、证券交易所或完全标准化的现代衍生品体系。课堂叙事必须区分实物米、藩仓米、仓单/米票、远期信用承诺、账本记录和后世经济史解释；不要编造具体米价、成交量、个人账本条目、某日政策命令或人物原话。机构材料和现代研究能解释制度、地点和概念，商人、武士和监管者更容易进入记录；普通低位账房、跑腿、搬运工、家庭成员、小农和消费者的直接声音较少保存。所有来源只做短摘记/转述，不放长版权原文，互动情节是基于多类来源的课堂合成叙事。',
    lessonPack: {
      inquiryQuestion: '堂岛米市如何把实物米、武士俸禄、藩财政、票据、价格消息和商人信用连成一个既创造机会又转嫁风险的城市系统？',
      quickStart: [
        '定位 1730 年前后大阪堂岛：城市仓储、藩仓米、武士俸禄和商人信用。',
        '圈出一条“米作为粮食”的证据和一条“米作为信用承诺”的证据。',
        '用一句话说明：为什么账房学徒不是市场旁观者，而是信用系统的低位节点？',
      ],
      classroomFlow: {
        quick: {
          title: '15 分钟米票与实物米区分',
          steps: ['读身份卡和清晨/午后 scene beats', '把证据分成实物米、票据、价格消息、监管四类', '写一句“堂岛不是现代市场等同物，因为……”'],
        },
        source: {
          title: '35 分钟堂岛来源边界实验室',
          steps: ['比较机构历史、货币博物馆材料和 scholarship 的视角', '为每条来源写“能证明 / 不能证明”', '合成一段不编造价格或成交量的谨慎解释'],
        },
        debate: {
          title: '30 分钟传闻改账听证会',
          steps: ['三组分别支持立刻改账、等待正式消息、求证后记录', '每组引用一条 scene 证据和一条来源边界', '观察员指出哪组最能区分当时可知信息与后见解释'],
        },
      },
      checkQuestions: [
        {
          question: '为什么不能把堂岛米市直接等同现代金融市场？',
          answer: '堂岛有组织化米交易、票据和信用安排，但制度、监管、信息技术、法律标准化和参与者结构都与现代市场不同；“期货”是有用的后世解释框架，不应抹平差异。',
          teacherNote: '要求学生至少指出一个相似点和一个差异点。',
        },
        {
          question: '米在本场景中有哪几重身份？',
          answer: '米是粮食、年贡/藩财政基础、武士俸禄尺度、城市商品、仓储对象、米票背后的承诺和价格波动中的信用工具。',
          teacherNote: '可让学生用概念图连接实物、财政、票据与信用。',
        },
        {
          question: '账房学徒的能动性体现在哪里？',
          answer: '他不能决定市场规则或藩财政，但能在核对、标注、传信、求证和提醒异常中影响信用链是否清楚，也承担错误责任。',
          teacherNote: '避免把低位角色写成现代交易员或完全被动的跑腿。',
        },
      ],
      misconceptions: [
        { misconception: '米票就是现代股票或电子合约。', correction: '米票/仓单可代表仓米或交易承诺，但其制度环境、法律执行、信息速度和参与者不同，不能用现代金融产品直接替换。' },
        { misconception: '商人信用只对富商重要，和学徒无关。', correction: '信用制度依赖抄写、传信、核对和跑腿等低位劳动；错误常由地位较低者承担。' },
        { misconception: '有账本就能知道真实交易全貌。', correction: '账本显示记录者关心和保存的内容，未必保存口头传闻、搬运劳动、家庭压力或小农/低位学徒声音。' },
      ],
      discussionRoles: [
        { role: '账房学徒 / 跑腿传信人', task: '说明速度、求证、笔迹责任和学徒地位之间的压力。' },
        { role: '资深账房', task: '维护店铺信用，要求账本可追溯，同时把错误责任压到下级。' },
        { role: '武士俸禄代理', task: '急于把米收入转化为可用银钱，关心报价和支付期限。' },
        { role: '现代来源审查员', task: '为机构材料、货币史和经济史研究标注解释边界。' },
      ],
      exitTickets: [
        '写一句谨慎判断：堂岛米市让米同时成为____和____，但不能直接等同____。',
        '指出本场景最重要的一条缺席声音，并说明你还需要哪类材料。',
      ],
    },
    activityPacks: [
      {
        id: 'dojima-rice-ticket-sort',
        title: '实物米、米票与信用承诺分类卡',
        mode: 'warmup',
        durationMinutes: 15,
        audience: '个人或两人一组',
        prompt: '把场景证据分成实物米、仓储记录、米票/票据、价格消息和后世解释五类，说明每类证据能支持什么判断。',
        materials: ['四个 Scene Reader', '关键术语卡', '时间线', '来源类型标签'],
        steps: ['列出 8 条证据。', '给每条贴上实物/票据/消息/监管/解释标签。', '写出一个容易混淆的概念并纠正。'],
        deliverable: '一张米与信用分类表 + 80 字概念纠偏。',
        successCriteria: ['能区分实物米和米票。', '能说明后世期货解释的边界。', '不编造具体价格或成交量。'],
        linkedSourceTitles: ['Osaka Exchange: History of Dojima Rice Exchange', 'Bank of Japan Currency Museum: money and early modern Japan'],
        linkedSceneBeatTitles: ['藏米未动，米票先被核对', '一句收成传闻摇动报价'],
      },
      {
        id: 'dojima-source-boundary-lab',
        title: '堂岛来源边界实验室',
        mode: 'source-lab',
        durationMinutes: 35,
        audience: '四人小组史料研读',
        prompt: '比较 Osaka Exchange、Bank of Japan Currency Museum、大阪历史博物馆材料与经济史研究：哪些能说明制度，哪些不能还原低位学徒的一天？',
        materials: ['六张来源卡', '事实 / 推论 / 缺席声音矩阵', '来源类型标签'],
        steps: ['给每条来源标注 primary、institution 或 scholarship。', '写出它最能证明的一件事。', '写出它遮蔽或无法直接说明的人。', '合成一句谨慎判断。'],
        deliverable: '来源边界矩阵 + 180 字堂岛解释。',
        successCriteria: ['至少比较三种来源类型。', '明确区分制度事实和课堂合成叙事。', '指出普通学徒、搬运工或家庭成员声音缺席。'],
        linkedSourceTitles: ['Osaka Exchange: History of Dojima Rice Exchange', 'The Evolution of Futures Trading: From Japanese Rice Markets to Modern Exchanges', 'Merchants and Society in Tokugawa Japan'],
        linkedSceneBeatTitles: ['藏米未动，米票先被核对', '油灯下，错误要有名字'],
      },
      {
        id: 'dojima-rumor-ledger-roleplay',
        title: '传闻、报价与改账听证会',
        mode: 'roleplay',
        durationMinutes: 30,
        audience: '三到五人角色扮演或课堂辩论',
        prompt: '围绕午后传闻是否写入账本，学徒、资深账房、经纪人、武士代理和监管书役分别说明自己的目标、风险和证据要求。',
        materials: ['决策选项', 'social actors', 'Scene Reader：午后传闻 / 夜里重算', '来源边界提示'],
        steps: ['每人抽取一个角色。', '用 45 秒提出建议。', '记录每种选择的即时后果和长期风险。', '全组形成一条可追溯的账本处理规则。'],
        deliverable: '一份“传闻是否入账”行动判断卡。',
        successCriteria: ['角色立场符合权力差异。', '能说明速度和可靠性冲突。', '至少引用一条来源限制。'],
        linkedSourceTitles: ['Tokugawa bakufu and Osaka rice market regulatory records', 'Merchants and Society in Tokugawa Japan'],
        linkedSceneBeatTitles: ['一句收成传闻摇动报价', '油灯下，错误要有名字'],
      },
      {
        id: 'dojima-paper-credit-route-compare',
        title: '纸面信用路线比较',
        mode: 'compare',
        durationMinutes: 28,
        audience: '小组比较或 Atlas 路线活动',
        prompt: '把堂岛学徒与 Fustat 商人信件学徒、巴格达抄写员、广州买办助手或马六甲通译比较：纸面记录怎样制造远距离信任？',
        materials: ['Atlas route：paper-credit-rice-and-port-ledgers-route', 'Compare Lens：市场与交换或来源可信度', '至少两张来源卡'],
        steps: ['选择一个比较场景。', '各找一条记录媒介证据。', '各找一条责任或来源边界证据。', '写出一条相似和一条差异。'],
        deliverable: '两站纸面信用比较卡：媒介 / 信任 / 风险 / 来源边界。',
        successCriteria: ['比较不只停留在“都有账本”。', '能说明记录如何连接远方货物或承诺。', '明确写出一条来源不能证明的内容。'],
        linkedSourceTitles: ['Osaka Exchange: History of Dojima Rice Exchange', 'Merchants and Society in Tokugawa Japan'],
        linkedSceneBeatTitles: ['桥上短笺比脚步更快', '油灯下，错误要有名字'],
      },
    ],
    missions: [
      {
        id: 'dojima-map-rice-credit-chain',
        title: '绘制米—票据—信用链',
        instruction: '把藩仓米、米票、经纪人、账房、武士俸禄代理、价格消息和监管者连成一条信用链，说明每个节点的风险。',
        evidenceUse: '使用清晨核对、午后传闻、夜里重算 scene beats、日常工作/风险切片和至少两条来源卡。',
        deliverable: '一张 7 节点米—票据—信用链图，附 120 字说明：哪里最容易把风险推给低位学徒？',
        estimatedMinutes: 22,
        difficulty: '入门',
        taskType: '因果链',
        steps: ['列出 7 个节点。', '标注每个节点处理的是实物、票据、消息还是责任。', '指出一个消息瓶颈和一个记录瓶颈。'],
        evidenceChecklist: ['包含藩仓米或武士俸禄。', '包含米票/账本。', '包含传闻或报价。', '至少点名两条来源。'],
        reflectionPrompt: '为什么远距离信任常要通过低位记录劳动才能成立？',
        outputTemplate: ['节点一：', '节点二：', '消息瓶颈：', '记录瓶颈：', '承担风险的人：', '谨慎结论：'],
        rubric: ['链条结构清楚。', '能区分实物米、票据和信用承诺。', '至少使用三条场景/来源证据。', '结论承认来源边界。'],
        sentenceStarters: ['藩仓米通过……进入账本。', '米票让……变成可交易承诺。', '风险不只在价格上，还在……', '现有来源不能直接说明……'],
        linkedSourceTitles: ['Osaka Exchange: History of Dojima Rice Exchange', 'Bank of Japan Currency Museum: money and early modern Japan'],
      },
      {
        id: 'dojima-judge-rumor-choice',
        title: '判断午后传闻后的账本选择',
        instruction: '站在账房学徒位置，在立刻改账、等待正式消息、求证后记录之间选择，并说明收益、风险和证据缺口。',
        evidenceUse: '使用决策选项、午后传闻/夜里重算 scene beats、日常行动空间和一条 institution 或 scholarship 来源。',
        deliverable: '一张 180 字角色判断卡：我会____，因为____；但来源不能告诉我____。',
        estimatedMinutes: 24,
        difficulty: '进阶',
        taskType: '角色判断',
        steps: ['选择一个行动。', '写出它保护谁、冒犯谁或拖累谁。', '用三条证据说明选择为何受限。', '写出一条不能由现有来源证明的个人心理或价格结果。'],
        evidenceChecklist: ['提到传闻或报价。', '提到账本/米票/责任链。', '包含一条来源可靠性说明。'],
        reflectionPrompt: '低位记录者的能动性为什么常表现为标注、求证和传信，而不是决定市场方向？',
        outputTemplate: ['我的选择：', '即时收益：', '长期风险：', '支持证据：', '不能确定：', '边界结论：'],
        rubric: ['判断符合学徒身份和信息限制。', '收益与风险权衡完整。', '至少引用三条证据。', '避免后见之明和现代金融术语直套。'],
        sentenceStarters: ['站在账房学徒的位置，我会……', '这个选择短期保护……', '但长期可能……', '来源只能说明……不能说明……'],
        linkedSourceTitles: ['Tokugawa bakufu and Osaka rice market regulatory records', 'The Evolution of Futures Trading: From Japanese Rice Markets to Modern Exchanges'],
      },
      {
        id: 'dojima-source-market-boundary',
        title: '校准“早期期货市场”说法',
        instruction: '说明堂岛米市为什么可被经济史视为早期有组织期货交易案例，也为什么不能被直接写成现代金融市场。',
        evidenceUse: '比较机构材料和 scholarship 的证据层级，至少引用一条 scene beat 和一个关键术语。',
        deliverable: '一张史料判断卡：可说 / 不能说 / 还需证据 / 缺席声音。',
        estimatedMinutes: 32,
        difficulty: '挑战',
        taskType: '史料判断',
        steps: ['选择至少四条不同类型来源。', '写出它们共同支持的谨慎判断。', '列出“现代金融类比”可能遮蔽的两个差异。', '指出低位账房、搬运工、小农或家庭成员声音为何缺席。'],
        evidenceChecklist: ['至少包含 institution 和 scholarship 各一条。', '明确写出“实物/票据/信用承诺/后世解释”至少三项区别。', '包含谨慎替代表述。'],
        reflectionPrompt: '历史解释为什么需要概念类比，也必须标注类比边界？',
        outputTemplate: ['可谨慎说：', '不能直接说：', '支持来源：', '来源限制：', '缺席声音：', '替代表述：'],
        rubric: ['来源类型判断准确。', '能区分制度事实与现代类比。', '明确指出缺席声音。', '结论语言谨慎、可被证据支撑。'],
        sentenceStarters: ['现有证据可以支持……', '但不能直接推出……', '这条来源需要谨慎，因为……', '更稳妥的表述是……'],
        linkedSourceTitles: ['Osaka Exchange: History of Dojima Rice Exchange', 'The Evolution of Futures Trading: From Japanese Rice Markets to Modern Exchanges', 'Merchants and Society in Tokugawa Japan'],
      },
    ],
    socialActors: [
      {
        id: 'self',
        name: '堂岛账房学徒',
        role: '核对米票、抄写账本、递送报价短笺',
        relationship: '核心决策者；地位低但接触账本、票据、经纪和传闻。',
        goals: '不误记、不迟报、保住学徒机会，帮助店铺维持信用，同时避免把未经核实传闻写成事实。',
        constraints: '不能决定报价规则或藩仓安排，必须服从资深账房和店主；时间紧、消息不完整、责任容易下压。',
        knowledgeLimits: '知道账房当天记录和听到的传闻，却不了解真实收成、幕府内部决定或所有经纪人的交易意图。',
        risksOrStakes: '抄错、漏传、被说迟钝、被当作错价替罪者、失去店铺信任或牵连家中生计。',
        likelyViewOfDecision: '倾向先求证并标注消息来源，除非资深账房明确要求立刻改账。',
        evidenceLinks: ['藏米未动，米票先被核对', '油灯下，错误要有名字', '决策选项'],
      },
      {
        id: 'senior-clerk',
        name: '资深账房',
        role: '管理总账、核对米票、向店主解释风险',
        relationship: '学徒的直接上级；教他规矩，也可能把错误责任交给下级笔迹。',
        goals: '维持账本清楚、店铺信用和与经纪/武士代理关系。',
        constraints: '面对价格波动、店主压力、监管关注和复杂票据，必须快速结算又不能显得轻率。',
        knowledgeLimits: '掌握更多关系网，但仍无法完全确认远方收成、藩财政或幕府行动。',
        risksOrStakes: '账目不合会损害店铺信用；若被怀疑投机或欺瞒，可能引来监管和客户流失。',
        likelyViewOfDecision: '支持求证和保留记录依据，但在行情急变时也会要求学徒迅速执行。',
        evidenceLinks: ['油灯下，错误要有名字', 'The Evolution of Futures Trading: From Japanese Rice Markets to Modern Exchanges'],
      },
      {
        id: 'samurai-stipend-agent',
        name: '武士俸禄代理',
        role: '替武士或藩相关人员处理俸米变现、借款或米票出售',
        relationship: '店铺客户或压力来源；关心米价、付款时点和票据信用。',
        goals: '把以米计的俸禄尽快转成可用银钱，减少价格下跌或延误风险。',
        constraints: '受俸禄制度、藩财政、个人债务、城市消费和市场报价影响。',
        knowledgeLimits: '知道自身现金压力，却未必理解所有账房核对和市场监管细节。',
        risksOrStakes: '报价不利或票据失信会影响家计、债务和身份体面。',
        likelyViewOfDecision: '可能催促立刻反应，不愿等太久，但也害怕账本错误损害兑付。',
        evidenceLinks: ['一句收成传闻摇动报价', 'Bank of Japan Currency Museum: money and early modern Japan'],
      },
      {
        id: 'rice-broker',
        name: '堂岛米经纪',
        role: '撮合米票/米交易、传递报价、维护商人网络名声',
        relationship: '学徒经常跑腿接触的人；消息来源之一，也是风险放大者。',
        goals: '维持交易速度、佣金和经纪名声，抢先获得可靠消息。',
        constraints: '受市场波动、客户信誉、监管目光和同业竞争限制。',
        knowledgeLimits: '消息多但真假混杂，可能只掌握某一圈子的报价或传闻。',
        risksOrStakes: '错误传闻会损害名声；过慢则失去客户。',
        likelyViewOfDecision: '倾向让账房快速承认行情变化，但会把最终账面责任留给商铺。',
        evidenceLinks: ['桥上短笺比脚步更快', '一句收成传闻摇动报价'],
      },
      {
        id: 'market-official-scribe',
        name: '城市监管书役',
        role: '关注市场秩序、价格波动和可能的投机行为',
        relationship: '不常直接面对学徒，但他的检查可能让账本成为证据。',
        goals: '维护交易秩序、减少社会不安、让市场服从幕府或城市治理要求。',
        constraints: '既需要米市流通，又担心过度投机、哄抬和民生压力。',
        knowledgeLimits: '看到的是报告、账本和投诉，不一定知道每条传闻如何在跑腿之间变化。',
        risksOrStakes: '监管失败会影响城市秩序；过度干预也可能扰乱信用和供应。',
        likelyViewOfDecision: '要求账本清楚、消息来源可解释，不鼓励把传闻伪装成已确认事实。',
        evidenceLinks: ['一句收成传闻摇动报价', 'Merchants and Society in Tokugawa Japan'],
      },
    ],
    socialEncounters: [
      {
        id: 'rumor-ledger-verification',
        title: '传闻、报价与账本责任协商',
        setting: '午后堂岛米商账房，学徒、经纪、武士俸禄代理和稍后归来的资深账房围绕是否按传闻改账争执。',
        decisionFocus: '是立刻把传闻转成报价和账目、等待正式消息，还是先求证并记录消息链？',
        actorIds: ['self', 'senior-clerk', 'samurai-stipend-agent', 'rice-broker', 'market-official-scribe'],
        tension: '经纪和俸禄代理要速度，资深账房要可追溯记录，监管者要求秩序；学徒站在所有人之间，既被需要又最容易被追责。',
        evidenceLinks: ['桥上短笺比脚步更快', '一句收成传闻摇动报价', '油灯下，错误要有名字', '决策选项'],
        taskChecklist: ['选择至少三位行动者比较立场', '标出每位行动者的目标与风险', '区分传闻、正式消息和后世解释', '引用一条来源可靠性边界', '形成一条有条件的账本处理规则'],
      },
    ],
    materialObjects: [
      {
        id: 'dojima-rice-ticket',
        name: '米票 / 藏米凭据',
        category: 'credit object',
        shortLabel: '米票',
        description: '米票把仓中或承诺中的米变成可转手、可记录和可争议的纸面对象。',
        objectBiography: '米票在藩仓、米商、经纪和客户之间流转；它的价值依赖仓米、信用、账本核对和市场接受，而不只是纸张本身。',
        everydayUse: '你需要抄写编号、票面、持有人和结算状态，确认它是否与仓米记录或前一日账本相合。',
        laborOrSkill: '需要识字、算盘、格式记忆和谨慎标注；一处误抄可能改变责任归属。',
        exchangeOrPower: '米票让远处仓米进入市场，也让持票者、商人和经纪围绕兑付、价格和信用展开权力关系。',
        evidenceLimit: '能帮助理解票据和信用，但不能证明某一天具体票号、价格或个人交易。',
        linkedSourceTitles: ['Osaka Exchange: History of Dojima Rice Exchange', 'The Evolution of Futures Trading: From Japanese Rice Markets to Modern Exchanges'],
        linkedSceneBeatTitles: ['藏米未动，米票先被核对', '油灯下，错误要有名字'],
        inquiryPrompts: ['米票与实物米有什么不同？', '谁保证纸面承诺能被相信？', '如果只看票据，哪些劳动会消失？'],
        tags: ['material culture', 'rice bills', 'credit', 'ledger', 'Dojima'],
      },
      {
        id: 'dojima-ledger-abacus',
        name: '账本、算盘与墨笔',
        category: 'record object',
        shortLabel: '账本算盘',
        description: '账本、算盘和墨笔把交易、传闻和责任压缩成可检查的数字、姓名和时刻。',
        objectBiography: '这些物件每天在账房中使用，记录未结票据、报价、客户关系和求证线索；夜里重算时，它们也成为追责工具。',
        everydayUse: '你磨墨、拨算盘、抄写临时账、在页边标注“未核”或消息来源，等待资深账房复核。',
        laborOrSkill: '显示低位商业识字、算术训练、格式纪律和在压力下保持清楚的技能。',
        exchangeOrPower: '账本建立店铺信用，也把错误固定成笔迹证据；谁能解释账本，谁就更能控制责任叙述。',
        evidenceLimit: '商家账本可说明记录制度，但普通学徒内心、口头争执和搬运劳动往往仍不直接可见。',
        linkedSourceTitles: ['Merchants and Society in Tokugawa Japan', 'The Evolution of Futures Trading: From Japanese Rice Markets to Modern Exchanges'],
        linkedSceneBeatTitles: ['藏米未动，米票先被核对', '油灯下，错误要有名字'],
        inquiryPrompts: ['账本如何同时保护交易和制造责任？', '为什么会算账是机会也是风险？', '账本没有保存哪些声音？'],
        tags: ['material culture', 'ledger', 'abacus', 'commercial literacy', 'responsibility'],
      },
      {
        id: 'dojima-price-slip',
        name: '报价短笺与袖中小札',
        category: 'message object',
        shortLabel: '价格短笺',
        description: '折起的短笺让报价、传闻和求证请求在堂岛桥边快速移动。',
        objectBiography: '短笺从账房到经纪人、仓边或客户处往返，可能在当天被销毁、誊入账本或成为争议依据。',
        everydayUse: '你把短笺塞进袖口，按指定顺序送达，并记住谁补充了哪一句口头消息。',
        laborOrSkill: '需要路线熟悉、称呼礼节、记忆力和判断哪些话可传、哪些必须标注未核。',
        exchangeOrPower: '消息速度能改变报价，也能让跑腿人承担“谁先说错”的责任；短笺连接信息优势和市场权力。',
        evidenceLimit: '短笺说明消息流的重要性，但不能证明具体传闻内容、传播速度或价格变动。',
        linkedSourceTitles: ['Merchants and Society in Tokugawa Japan', 'Tokugawa bakufu and Osaka rice market regulatory records'],
        linkedSceneBeatTitles: ['桥上短笺比脚步更快', '一句收成传闻摇动报价'],
        inquiryPrompts: ['消息什么时候比正式文书更有力量？', '跑腿传信人如何影响信用链？', '传闻进入账本前应怎样标注？'],
        tags: ['material culture', 'message', 'rumor', 'prices', 'brokerage'],
      },
      {
        id: 'dojima-rice-sample-measure',
        name: '米样、量器与仓印',
        category: 'commodity object',
        shortLabel: '米样量器',
        description: '米样和量器提醒人们：纸面信用最终仍指向可食用、可储藏、质量有差异的实物米。',
        objectBiography: '米样可能来自仓库或商铺，用于判断品质、产地或兑付可信度；量器和仓印把实物米纳入可比较的商业语言。',
        everydayUse: '你偶尔被派去确认仓边标记、搬取小样或向资深账房报告米质传言。',
        laborOrSkill: '需要辨认标记、听懂品质称呼，并知道不能把传闻中的米质直接写成确定事实。',
        exchangeOrPower: '实物品质影响票据信用和报价；仓库、商人和经纪人对品质解释拥有不平等权力。',
        evidenceLimit: '能连接粮食与票据，但不能推定某日具体仓米品质、数量或交易价格。',
        linkedSourceTitles: ['Osaka Museum of History materials on Osaka as tenka no daidokoro', 'Bank of Japan Currency Museum: money and early modern Japan'],
        linkedSceneBeatTitles: ['藏米未动，米票先被核对', '一句收成传闻摇动报价'],
        inquiryPrompts: ['纸面承诺为什么仍依赖实物质量？', '谁有权判断米质？', '米作为食物和财政尺度有何不同？'],
        tags: ['material culture', 'rice', 'warehouse', 'commodity', 'quality'],
      },
    ],
    keyTerms: [
      { term: 'Dojima Rice Exchange', definition: '大阪堂岛一带形成的有组织米市场；后世经济史常讨论其米票、经纪、结算和早期期货交易特征，但不能直接等同现代金融市场。' },
      { term: '蔵米 / 藩仓米', definition: '各藩作为年贡或财政资源储藏、运输和出售的米；在大阪仓储和米商网络中常被转化为现金或信用安排。' },
      { term: '米票 / rice bill', definition: '与仓米、交割或交易承诺相关的纸面凭据；它让远处米变成可记录和转手的信用对象。' },
      { term: '武士俸禄货币化', definition: '武士收入常以米计量，但城市生活和藩财政需要把俸米出售、抵押或兑换为银钱。' },
      { term: '天下厨房', definition: '对大阪仓储、批发、金融和供应功能的概括性称呼；强调大阪在德川日本城市经济中的枢纽地位。' },
      { term: '米仲买 / rice broker', definition: '撮合米或米票交易、传递报价和维护商人关系的中介；其信用与消息网络影响市场运行。' },
      { term: '先物取引', definition: '后世用于描述未来交割/远期交易的概念；用于堂岛时需谨慎说明制度相似与时代差异。' },
      { term: 'source silence', definition: '来源较少保存低位账房、跑腿、搬运工、家庭成员、小农或消费者直接声音，历史叙事需标注这种沉默。' },
    ],
    compareAngles: [
      { title: '堂岛 vs. Fustat', prompt: '米票与 Geniza 商人信件都让远方承诺可执行；它们分别依赖哪些社群、账本、见证和来源保存条件？' },
      { title: '堂岛 vs. 广州口岸', prompt: '大阪米商账房和广州买办助手都在账本、报价和监管之间工作；他们承担的法律/信用风险有何异同？' },
      { title: '堂岛 vs. 马六甲', prompt: '堂岛跑腿和马六甲通译都传递消息与信任；语言、票据、税册和传闻如何塑造中介劳动？' },
      { title: '米作为粮食 vs. 米作为信用', prompt: '当同一种米既能吃、又能计俸、又能成为票据承诺时，历史论证如何避免把这些身份混成一种？' },
    ],
    sourceEvidenceUse:
      '先用 Osaka Exchange / 堂岛历史材料和大阪历史博物馆相关城市史材料确认堂岛、米市和“天下厨房”的制度/地点框架；用 Bank of Japan Currency Museum 等货币史材料解释米、银钱、俸禄和德川货币经济；再用 Schaede、Hamori、Najita、Berry 等研究校准堂岛米市、商人信用、清算/经纪、城市社会和思想语境。所有来源只做短摘记/转述，不放长版权原文；使用时必须区分实物米、仓单/米票、信用承诺和后世经济史解释，不编造具体米价、成交量、个人账本或人物原话，并说明普通低位账房、跑腿、搬运工、家庭成员、小农和消费者声音较少直接保存。',
    sources: [
      {
        title: 'Osaka Exchange: History of Dojima Rice Exchange',
        creator: 'Osaka Exchange / Japan Exchange Group',
        sourceType: 'institution',
        relevance: '机构历史提供堂岛米市、米票交易和交易所记忆的基本框架，便于定位地点、制度和后世解释。',
        excerpt: '材料概述大阪堂岛米市场在日本交易所历史中的地位，把米交易、票据和有组织市场联系起来。',
        sourceQuestion: '机构叙述能帮助确认哪些制度框架？它为什么可能更强调交易所谱系而非低位学徒经验？',
        reliabilityNote: '适合核对堂岛作为制度案例和后世交易所记忆；作为机构叙述，可能把历史整理成现代交易所前史，需避免直接等同现代市场。',
        perspective: '现代交易所机构历史和市场制度记忆视角',
        evidenceTags: ['Dojima', 'rice exchange', 'institution source', 'rice bills', 'market history', 'source limits'],
        url: 'https://www.jpx.co.jp/english/corporate/about-jpx/history/01.html',
      },
      {
        title: 'Bank of Japan Currency Museum: money and early modern Japan',
        creator: 'Bank of Japan Currency Museum',
        sourceType: 'institution',
        relevance: '货币博物馆材料可帮助说明德川时期货币、米、银钱和经济生活之间的关系。',
        excerpt: '材料把日本货币史、金银铜钱和近世经济联系起来，适合讨论米俸禄如何与现金支付并存。',
        sourceQuestion: '货币史材料如何帮助我们理解“以米计量”和“以银钱支付”的差别？',
        reliabilityNote: '可靠的机构概览，但通常不会展开堂岛某家店铺、低位账房或具体交易争议。',
        perspective: '现代中央银行博物馆、货币制度和经济教育视角',
        evidenceTags: ['money', 'Tokugawa economy', 'rice stipends', 'currency', 'institution source'],
        url: 'https://www.imes.boj.or.jp/cm/english/',
      },
      {
        title: 'Osaka Museum of History materials on Osaka as tenka no daidokoro',
        creator: 'Osaka Museum of History',
        sourceType: 'institution',
        relevance: '大阪城市史与博物馆材料有助于校准大阪“天下厨房”、仓储、批发和城市商业空间。',
        excerpt: '机构材料常把大阪的水运、仓储、批发市场和城市生活联系起来，说明堂岛并非孤立交易点。',
        sourceQuestion: '城市博物馆材料能怎样把米市放回水运、仓储和町人社会中？',
        reliabilityNote: '适合城市背景和空间理解；展陈叙事高度概括，不能替代商铺账本或普通跑腿自述。',
        perspective: '现代城市博物馆、地方历史和公共史视角',
        evidenceTags: ['Osaka', 'tenka no daidokoro', 'urban history', 'warehousing', 'public history'],
        url: 'https://www.osakamushis.jp/eng/',
      },
      {
        title: 'The Evolution of Futures Trading: From Japanese Rice Markets to Modern Exchanges',
        creator: 'Ulrike Schaede',
        sourceType: 'scholarship',
        relevance: '关于堂岛米市和期货交易演化的研究，可用于讨论制度创新与现代类比的边界。',
        excerpt: '研究把日本米市场放入期货交易发展史中，强调制度、合约、清算和市场组织的重要性。',
        sourceQuestion: '经济史如何使用“futures”概念？课堂上应怎样防止把后世概念倒推成完全相同制度？',
        reliabilityNote: '有助于理解堂岛在市场制度史中的意义；但学术概念是解释框架，不能生成某个学徒的一日细节或具体价格。',
        perspective: '现代经济史、金融市场制度演化视角',
        evidenceTags: ['scholarship', 'futures trading', 'Dojima', 'market institutions', 'anachronism risk'],
      },
      {
        title: 'Tokugawa bakufu and Osaka rice market regulatory records',
        creator: 'Tokugawa bakufu / Osaka machi-bugyō officials',
        sourceType: 'primary',
        relevance: '幕府与大阪町奉行相关市场规制、经纪管理或价格秩序材料，可作为理解监管关注的原始制度线索。',
        excerpt: '这类记录通常把米市放在价格秩序、经纪行为、城中治安和民生稳定中处理，显示官府并非把市场视为完全自治空间。',
        sourceQuestion: '监管记录能证明官府关心哪些市场风险？它为什么不能直接告诉我们学徒、搬运工或消费者如何感受价格波动？',
        reliabilityNote: '接近当时制度语言和治理关切，但视角来自官府，重点是秩序、责任和可管理性；不能单独还原商铺内部日常或个人心理。',
        perspective: '德川幕府 / 大阪城市治理和监管者视角',
        evidenceTags: ['primary source', 'regulation', 'Dojima', 'rice market', 'brokers', 'public order', 'absent voices'],
      },
      {
        title: 'Merchants and Society in Tokugawa Japan',
        creator: 'Tetsuo Najita / Mary Elizabeth Berry and Tokugawa social historians',
        sourceType: 'scholarship',
        relevance: '德川商人、城市社会、信用伦理和町人世界研究，有助于把账房学徒放进商铺等级、名声和城市秩序中。',
        excerpt: '研究强调德川城市社会中商人、信用、身份和道德语言的复杂关系，而不是把市场活动写成纯粹逐利。',
        sourceQuestion: '商人社会史如何补足交易所制度史？它仍然看不见哪些低位劳动者日常？',
        reliabilityNote: '能帮助解释商人信用、等级和城市社会；仍需承认普通学徒、女性家庭成员、搬运工和小农直接声音不足。',
        perspective: '现代德川社会史、城市史和商人文化研究视角',
        evidenceTags: ['scholarship', 'Tokugawa merchants', 'urban society', 'credit ethics', 'absent voices'],
      },
    ],
  },
  {
    id: 'suez-canal-corvee-water-carrier',
    title: '苏伊士运河工地送水人的一天',
    era: '19 世纪中叶埃及、欧洲运河公司与全球航运想象交汇期',
    year: 1863,
    location: '苏伊士地峡运河工地 / 提姆萨赫湖附近营地',
    region: '埃及 / 地中海—红海通道',
    coordinates: [30.5897, 32.2654],
    identity: '从尼罗河三角洲村庄被征调到运河工地的埃及劳役农民',
    role: '给开挖队送水、搬运泥土，并在工棚里帮不识字同伴核对名单记号',
    age: 23,
    theme: '苏伊士运河、劳役、淡水供应、疾病、债务、欧洲公司与基础设施进步代价',
    accent: '#4f8f9f',
    summary:
      '你原本在三角洲村庄耕地，却被派到苏伊士地峡的运河工地。白天你背水囊沿着沟槽和沙堤送水，夜里替同村人辨认工棚名单上的记号。工程师谈论地中海与红海、蒸汽船和世界贸易；你更先听见的是口渴、病人咳嗽、债主催款和回家日期迟迟不明。',
    atmosphere:
      '盐碱地的风把沙粒吹进眼角，运河槽里铁锹、箩筐和喊号声交错。淡水来得慢，水囊有皮革、泥和汗的味道；棚屋里人名、村名、缺勤记号和病倒传闻挤在一张纸边。远方报纸把这条沟写成世界航运捷径，脚下的人却先用肩膀、胃和皮肤丈量它。',
    sceneBeats: [
      {
        timeLabel: '黎明点名',
        title: '村名先被喊进沙地',
        sensoryDetail: '天还灰蓝，工棚外已经排起队。书记员喊村名和人名，缺席者旁边被划上短短记号，湿冷的晨风很快变成干热。',
        historicalTension: '运河开挖依赖埃及国家征调、地方中间人和公司工程安排；名单把劳役者变成可点数的人力，却很少保存他们自己的解释。',
        evidenceHook: '把 Suez Canal Company 报告和外交通信中的人力/工程条目，与劳役者声音缺席并读，讨论“被点名”不等于“被听见”。',
        learnerPrompt: '点名册能证明哪些事实？它为什么不能直接告诉我们劳役者如何理解被征调？',
        linkedDailyLifeKeys: ['work', 'risks', 'freedoms'],
        linkedSourceTitles: ['Compagnie universelle du canal maritime de Suez reports and correspondence', 'British Parliamentary Papers: correspondence respecting the Suez Canal'],
      },
      {
        timeLabel: '正午送水',
        title: '水囊比工程图更沉',
        sensoryDetail: '皮水囊勒住肩膀，水从缝线处渗到衣服上又立刻被热风烤干；沟槽边的人伸手接碗，沙土在牙缝里发涩。',
        historicalTension: '淡水供应是地峡工程的关键瓶颈之一；工程叙述常把水渠、泵站或运输写成技术问题，送水人的劳动和疾病风险却容易被压成背景。',
        evidenceHook: '用运河公司、Suez Canal Authority 和 Britannica 对淡水渠/工程阶段的概述，追问“供应系统”背后需要谁搬运、排队和承受短缺。',
        learnerPrompt: '为什么“淡水供应改善”不能自动等同于工地普通人已经安全？请列出至少两个中间环节。',
        linkedDailyLifeKeys: ['food', 'work', 'risks'],
        linkedSourceTitles: ['Suez Canal Authority: history of the canal', 'Encyclopaedia Britannica: Suez Canal'],
      },
      {
        timeLabel: '傍晚传闻',
        title: '蒸汽船捷径从病棚旁经过',
        sensoryDetail: '太阳落下后，远处传来有人说欧洲报纸称这条运河会改变世界航线；同一排棚里，病人的咳声和要不要停工的低语盖过了兴奋。',
        historicalTension: '全球航运、帝国竞争和资本想象把运河写成进步象征，但工地上的疾病、离乡、债务和不确定期限让普通人以完全不同尺度体验同一工程。',
        evidenceHook: '比较欧洲报刊/旅行记和现代研究对“世界交通革命”的叙述，标出哪些属于宏观想象，哪些仍需回到工地劳动证据。',
        learnerPrompt: '如果一条运河让远方商船更快，它是否也让送水人的生活更好？回答时必须说明证据边界。',
        linkedDailyLifeKeys: ['home', 'risks', 'freedoms'],
        linkedSourceTitles: ['Parting the Desert: The Creation of the Suez Canal', 'Egypt in the Nineteenth Century: Mehemet Ali to British Occupation'],
      },
      {
        timeLabel: '夜里记号',
        title: '工棚名单上的黑点',
        sensoryDetail: '油灯烟把棚顶熏黑，你用炭笔帮同村人认名单：谁被记为在场，谁病倒，谁欠了路上垫付的钱，谁托人带话回村。',
        historicalTension: '一点识字能力让你能帮助同伴理解名单和债务，也让你被卷入书记员、中间人和工头之间的责任链。记录保护人，也可能固定欠账、缺勤和惩罚。',
        evidenceHook: '用国家/公司记录与社会史研究讨论：低位记录助手能看见规则，却很少能改变规则；名单是证据，也是权力工具。',
        learnerPrompt: '为什么会认字既是机会也是风险？请写出名单能帮助同伴的一面和可能伤害同伴的一面。',
        linkedDailyLifeKeys: ['education', 'work', 'risks', 'freedoms'],
        linkedSourceTitles: ['Colonialism and Revolution in the Middle East', 'Compagnie universelle du canal maritime de Suez reports and correspondence'],
      },
    ],
    dailyLife: [
      {
        ...
        label: '饮食',
        title: '面饼、豆子和不够稳的淡水',
        text: '你的饭食多是面饼、豆类、洋葱、少量腌制或干货。真正决定一天能否撑下去的是淡水：水可能来自临时运输、渠线或分发点，等待、混浊、短缺和病痛都让“喝水”变成劳动问题。',
      },
      {
        key: 'home',
        label: '居所',
        title: '三角洲村庄在名单之外',
        text: '家在尼罗河三角洲，田地、家人、村里债务和播种收成都被留在身后。你住在临时工棚或营地，靠同村人、亲族称呼和偶尔带回的口信维持家的存在感。',
      },
      {
        key: 'work',
        label: '工作',
        title: '送水、搬土和核对记号',
        text: '白天你背水、递碗、搬筐、清理泥沙，按工头和路线安排在开挖线移动；夜里因略识字，帮同伴辨认名单、缺勤记号、村名和欠账提示。你的劳动不是工程图上单独一项，却支撑了开挖队继续工作。',
      },
      {
        key: 'education',
        label: '学习',
        title: '在清真寺学过的字变成工棚工具',
        text: '你可能只会读写少量阿拉伯字、数字和村名，却足以在工棚里帮人确认名字、记号、口信和债务。识字让你获得同伴信任，也让书记员和中间人更容易把杂事推给你。',
      },
      {
        key: 'risks',
        label: '风险',
        title: '热、病、惩罚、债和回不去的日期',
        text: '风险来自缺水、污染、传染病、晒伤、疲劳、工地事故、惩罚、逃离失败、工资/口粮争议、路费或家中债务。后世来源还带来解释风险：工程数据常比身体经验保存得更清楚。',
      },
      {
        key: 'freedoms',
        label: '行动空间',
        title: '小范围协商，不是自由迁移',
        text: '你能选择先给哪一组送水、是否替病人说情、如何在名单上提醒同伴，但很难自由离开工地或决定工程安排。行动空间存在于同伴互助、路线绕行和与书记员/中间人协商之间。',
      },
    ],
    timeline: [
      { year: '1854-1856', title: '运河特许权与公司设想形成', text: 'Ferdinand de Lesseps 获得埃及统治者支持，苏伊士运河公司逐步形成；计划把地中海与红海连接，吸引欧洲资本和外交关注。' },
      { year: '1859', title: 'Port Said 附近开始开挖', text: '运河工程从北端启动，早期阶段依赖大量人工开挖、工地调度、临时营地和物资供应。' },
      { year: '1862-1863', title: '劳役、淡水和疾病成为工地核心问题', text: '本场景设在开挖阶段：埃及劳役、淡水供应、营地健康和国际批评交织。不要把任何单一工程数字直接当成劳动体验。' },
      { year: '1863-1864', title: '劳役制度受到外交与政治压力', text: '围绕 corvée 劳役的争议加剧，埃及国家、运河公司和欧洲权力之间重新协商工程劳动力安排。具体执行因地点和时间不同而变化。' },
      { year: '1869', title: '苏伊士运河正式通航', text: '运河开通后成为全球航运和帝国战略的重要通道，但开通庆典和航运收益不能抹去早期开挖阶段普通劳役者的代价。' },
      { year: '1882以后', title: '英国占领与后续解释边界', text: '英国占领埃及后，运河的战略意义进一步上升。后世叙述常从帝国交通、资本或国家建设角度解释运河，需要主动补问普通劳动者声音为何稀少。' },
    ],
    decision: {
      prompt: '正午路线还没送完，沟槽边一名同村劳役者发热、呕吐，旁边工头催你继续按路线送水。夜里书记员又会核对名单和缺勤记号。你怎么做？',
      context:
        '如果你继续送水，更多开挖队能喝到水，你也不容易被记为延误；如果停下照看病人，可能救同村人却让路线中断；如果去找中间人或书记员求情，可能换来病号记号或休息，也可能把你卷入责任和贿赂/债务关系。你掌握的医学知识有限，也无法决定劳役制度。',
      options: [
        {
          id: 'follow-water-route',
          label: '按路线继续送水',
          stance: '守住职责，避免被罚',
          description: '把病人托给旁边同村人，自己继续沿既定路线给开挖队送水，晚上再回棚查看。',
          immediate: '路线不中断，工头较难指责你延误；更多人能及时喝水，但病人眼下可能缺少照看。',
          longTerm: '你保住工地信誉和少量协商空间，却可能失去同村人的信任，也让疾病风险继续被当成个人问题而不是系统问题。',
          reflection: '在强制劳动系统中，“尽责”可能同时保护自己、帮助多数人，也牺牲最近处需要帮助的人。',
        },
        {
          id: 'care-for-sick-worker',
          label: '停下照看病人',
          stance: '优先同伴生命和互助',
          description: '把水囊放下，给病人阴凉、水和同村人帮助，试着让另一名送水人接替路线。',
          immediate: '病人得到短暂照看，同村人会记得你的帮助；但路线延误可能让别的队口渴，也可能被工头记名。',
          longTerm: '互助关系加强，未来你病倒时也可能有人帮忙；但缺勤或延误记号可能影响口粮、惩罚或能否早日回村。',
          reflection: '普通人的道德选择不是在安全中作出，而是在惩罚、短缺和疾病之间给彼此争取一点空间。',
        },
        {
          id: 'petition-scribe-mediator',
          label: '找中间人或书记员求情',
          stance: '用记录协商风险',
          description: '带着病人的村名和名单记号去找中间人/书记员，请他把病人记为病号而不是逃工或延误。',
          immediate: '如果对方愿意，病人可能获得短暂休息或免于错误惩罚；但求情需要时间，也可能被要求人情、钱或额外劳动。',
          longTerm: '你学会利用记录系统保护同伴，却也更依赖中间人权力；名单一旦写错，错误会更难推翻。',
          reflection: '记录不是中性的：它可以把苦难变成可申诉的事实，也可以把人固定为缺勤、欠债或麻烦。',
        },
      ],
    },
    realHistory:
      '苏伊士运河工程在 1859 年启动，1869 年通航。早期开挖阶段与埃及国家征调劳役、欧洲公司资本、国际外交压力、淡水供应工程、疾病和营地生活紧密相连。运河最终显著改变地中海—红海—印度洋航运和帝国战略格局，但这条全球“捷径”不是单靠工程蓝图完成的；它依赖大量埃及劳动者、工地后勤、淡水系统、地方中间人和记录体系。关于劳役人数、死亡、工资、工时和具体营地实践，来源常有口径差异或视角偏向；本场景不编造精确数字，而把重点放在证据能支持的劳动结构、风险和解释边界上。',
    interpretationNote:
      '本场景合成一名 1862/1863 年苏伊士运河工地上的埃及送水人 / 劳役农民 / 工棚记录助手，不对应单一可查人物。运河公司报告、工程文书和欧洲报刊常强调进度、资本、技术难题和全球航运意义；埃及国家记录和外交材料更关注征调、主权、劳动力安排和国际压力；后世机构叙述常从工程成功和国家地标解释；现代学者则把运河放入帝国资本、埃及国家建设、劳役制度和英国占领背景中分析。劳役者本人留下的直接声音极少，尤其是送水人、病人、女性亲属和村庄债务关系。不要把工程数据、通航年份或公司叙述等同于劳动体验；不要编造具体死亡人数、工资、工时、个人原话或某一份名单上的姓名。互动情节是基于多类来源的课堂合成叙事，只能用短摘记和转述来训练来源判断。',
    lessonPack: {
      inquiryQuestion: '当国家工程、欧洲公司、淡水供应、疾病、劳役、债务与全球航运想象交织时，普通人如何理解和承受“基础设施进步”的代价？',
      quickStart: [
        '定位 1862/1863 年：苏伊士地峡、运河开挖、埃及劳役、淡水瓶颈。',
        '圈出一条“工程进步”证据和一条“劳动代价”证据。',
        '用一句话说明：为什么送水人不是工程背景，而是工程系统的一部分？',
      ],
      classroomFlow: {
        quick: {
          title: '15 分钟基础设施代价拆解',
          steps: ['读身份卡和四个 scene beats', '把证据分成工程/淡水/劳役/疾病/记录五类', '写出一条“进步—代价—来源边界”句子'],
        },
        source: {
          title: '35 分钟工程报告与缺席声音 Source Lab',
          steps: ['比较公司报告、外交通信、机构历史和 scholarship 的视角', '标注每条来源能证明的系统事实和不能证明的劳动体验', '写一段不使用精确死亡/工资/工时数字的谨慎解释'],
        },
        debate: {
          title: '30 分钟水路选择听证会',
          steps: ['三组分别支持继续送水、照看病人、找书记员求情', '每组必须引用一条日常/scene 证据和一条来源限制', '观察员指出哪种发言把基础设施进步说得过于单线'],
        },
      },
      checkQuestions: [
        {
          question: '为什么不能把苏伊士运河的工程数据直接等同于劳役者经验？',
          answer: '工程数据能说明进度、路线、资金或技术瓶颈，却通常不会保存送水、疾病、恐惧、同伴互助、债务和回村压力等身体经验。',
          teacherNote: '要求学生用“能证明 / 不能证明”格式回答。',
        },
        {
          question: '淡水供应为什么既是技术问题也是社会问题？',
          answer: '水渠、运输或分发是技术系统，但谁背水、谁排队、谁先喝、谁因水质或短缺生病，都由劳役组织、营地秩序和权力关系决定。',
          teacherNote: '把基础设施节点和人力劳动连起来。',
        },
        {
          question: '本场景中送水人的能动性体现在哪里？',
          answer: '不在决定运河是否开挖，而在路线顺序、同伴互助、求情、辨认名单、记录边界和保护自己免受惩罚的微小选择中。',
          teacherNote: '避免把低位角色写成完全被动或现代式抗议英雄。',
        },
      ],
      misconceptions: [
        { misconception: '运河通航改善世界交通，所以对所有相关人都是进步。', correction: '航运效率和普通劳役者处境不是同一尺度；进步可能同时产生收益和把代价转嫁给低位劳动者。' },
        { misconception: '公司或国家报告有数字，所以比个人经验更完整。', correction: '数字能回答工程和行政问题，但常遮蔽身体、情感、村庄债务和缺席声音。' },
        { misconception: '劳役者没有直接文字，就不能讨论他们。', correction: '可以谨慎使用工程、外交、机构和研究材料推断结构性处境，但必须标注沉默和不确定性。' },
      ],
      discussionRoles: [
        { role: '送水人 / 工棚记录助手', task: '说明路线、病人、名单和自保之间的选择压力。' },
        { role: '埃及地方中间人', task: '说明征调、名单和上级压力如何落到村庄与营地。' },
        { role: '运河公司工程师', task: '强调淡水、进度和后勤难题，同时回应劳动体验为何被报告压缩。' },
        { role: '现代来源审查员', task: '为公司、外交、机构和 scholarship 材料标注视角与可靠边界。' },
      ],
      exitTickets: [
        '写一句谨慎判断：苏伊士运河是____的基础设施，同时也是____的劳动系统。',
        '指出本场景最重要的一条缺席声音，并说明你还需要哪类材料。',
      ],
    },
    activityPacks: [
      {
        id: 'suez-water-route-pressure-map',
        title: '送水路线压力图',
        mode: 'warmup',
        durationMinutes: 15,
        audience: '个人或两人一组',
        prompt: '把黎明点名、正午送水、傍晚病棚和夜间名单连成一张压力图，说明每个节点谁受益、谁承担风险。',
        materials: ['四个 Scene Reader', '日常生活：工作/风险/行动空间', '决策选项卡'],
        steps: ['画出 4 个节点。', '为每个节点标注水、名单、疾病或惩罚压力。', '写出一个节点失灵后会影响哪些人。'],
        deliverable: '一张水路压力图 + 100 字节点失败说明。',
        successCriteria: ['能把淡水供应和人力劳动连接起来。', '能说明至少两个风险转移环节。', '不使用未经证实的精确数字。'],
        linkedSourceTitles: ['Suez Canal Authority: history of the canal', 'Encyclopaedia Britannica: Suez Canal'],
        linkedSceneBeatTitles: ['村名先被喊进沙地', '水囊比工程图更沉'],
      },
      {
        id: 'suez-source-boundary-lab',
        title: '工程报告与劳役沉默来源实验室',
        mode: 'source-lab',
        durationMinutes: 35,
        audience: '四人小组史料研读',
        prompt: '比较运河公司/工程报告、英国外交通信、Suez Canal Authority、Britannica、Karabell 与 Cole：哪些能说明工程和外交，哪些不能直接还原送水人的体验？',
        materials: ['六张来源卡', '事实 / 推论 / 缺席声音矩阵', '来源类型标签'],
        steps: ['给每条来源标注 primary、institution 或 scholarship。', '写出它最能证明的一件事。', '写出它最容易遮蔽的人或经验。', '合成一句不超过 180 字的谨慎判断。'],
        deliverable: '来源边界矩阵 + 180 字谨慎解释。',
        successCriteria: ['至少比较三种来源类型。', '明确指出劳役者直接声音稀少。', '能区分工程数据和劳动体验。'],
        linkedSourceTitles: ['Compagnie universelle du canal maritime de Suez reports and correspondence', 'British Parliamentary Papers: correspondence respecting the Suez Canal', 'Colonialism and Revolution in the Middle East'],
        linkedSceneBeatTitles: ['村名先被喊进沙地', '工棚名单上的黑点'],
      },
      {
        id: 'suez-sick-worker-roleplay',
        title: '病人、水路与名单听证会',
        mode: 'roleplay',
        durationMinutes: 30,
        audience: '三到五人角色扮演或课堂辩论',
        prompt: '围绕病人倒下后的选择，送水人、病人同村人、工头、书记员和工程师分别说明该继续送水、停下照看还是找中间人求情。',
        materials: ['决策选项', 'social actors', 'Scene Reader：正午送水 / 夜里记号', '来源边界提示'],
        steps: ['每人抽取一个角色并写出目标与限制。', '轮流用 45 秒给出建议。', '记录每种选择的即时后果、长期风险和证据缺口。', '全组形成一条带来源边界的行动判断。'],
        deliverable: '一份病人—水路—名单行动判断卡。',
        successCriteria: ['角色立场符合身份与权力差异。', '能说明同伴互助和制度惩罚之间的张力。', '至少引用一条来源限制。'],
        linkedSourceTitles: ['British Parliamentary Papers: correspondence respecting the Suez Canal', 'Parting the Desert: The Creation of the Suez Canal'],
        linkedSceneBeatTitles: ['水囊比工程图更沉', '工棚名单上的黑点'],
      },
      {
        id: 'suez-global-route-compare',
        title: '运河捷径与港口劳动比较',
        mode: 'compare',
        durationMinutes: 28,
        audience: '小组比较或 Atlas 路线活动',
        prompt: '把苏伊士送水人与 Fustat 商人学徒、马六甲港口通译或孟买女工比较：连接世界的系统如何依赖普通劳动？',
        materials: ['Atlas route：canal-steam-and-labor-route', 'Compare Lens：制度约束或市场与交换', '至少两张来源卡'],
        steps: ['选择一个比较场景。', '各找一条连接世界的系统证据。', '各找一条普通劳动或风险证据。', '写出一条相似和一条差异。'],
        deliverable: '两站比较卡：系统 / 劳动 / 风险 / 来源边界。',
        successCriteria: ['比较不只停留在地图距离。', '能说明制度或市场如何安排劳动。', '明确写出一条来源不能证明的内容。'],
        linkedSourceTitles: ['Parting the Desert: The Creation of the Suez Canal', 'Suez Canal Authority: history of the canal'],
        linkedSceneBeatTitles: ['蒸汽船捷径从病棚旁经过', '水囊比工程图更沉'],
      },
    ],
    missions: [
      {
        id: 'suez-map-water-labor-chain',
        title: '绘制淡水—劳役链',
        instruction: '把淡水来源、送水路线、开挖队、病棚、名单和中间人连成一条系统链，说明每个节点的风险。',
        evidenceUse: '使用正午送水、夜里记号 scene beats、日常风险/工作切片和至少两条来源卡。',
        deliverable: '一张 6 节点淡水—劳役链图，附 120 字说明：哪里最像基础设施瓶颈？',
        estimatedMinutes: 20,
        difficulty: '入门',
        taskType: '因果链',
        steps: ['列出 6 个节点。', '为每个节点标注水、劳动、记录或疾病风险。', '指出一个技术瓶颈和一个制度瓶颈。'],
        evidenceChecklist: ['包含淡水供应。', '包含送水人或开挖队。', '包含名单/中间人。', '至少点名两条来源。'],
        reflectionPrompt: '为什么基础设施的瓶颈常常由普通人的身体承担？',
        outputTemplate: ['节点一：', '节点二：', '技术瓶颈：', '制度瓶颈：', '承担风险的人：', '谨慎结论：'],
        rubric: ['链条结构清楚。', '能区分技术与制度瓶颈。', '至少使用三条场景/来源证据。', '结论承认来源边界。'],
        sentenceStarters: ['淡水从……进入工地。', '送水人的劳动连接了……', '瓶颈不只在技术上，还在……', '现有来源不能直接说明……'],
        linkedSourceTitles: ['Suez Canal Authority: history of the canal', 'Compagnie universelle du canal maritime de Suez reports and correspondence'],
      },
      {
        id: 'suez-judge-sick-worker-choice',
        title: '判断病人倒下后的选择',
        instruction: '站在送水人位置，在继续送水、照看病人、找书记员求情之间选择，并说明收益、风险和证据缺口。',
        evidenceUse: '使用决策选项、正午送水/夜间名单 scene beats、日常行动空间和一条外交通信或 scholarship 来源。',
        deliverable: '一张 180 字角色判断卡：我会____，因为____；但来源不能告诉我____。',
        estimatedMinutes: 24,
        difficulty: '进阶',
        taskType: '角色判断',
        steps: ['选择一个行动。', '写出它保护谁、伤害或冒犯谁。', '用三条证据说明选择为何受限。', '写出一条不能由现有来源证明的个人心理或结果。'],
        evidenceChecklist: ['提到淡水路线或病人。', '提到名单/惩罚/中间人。', '包含一条来源可靠性说明。'],
        reflectionPrompt: '低位劳动者的能动性为什么常表现为微小协商，而不是改变整个工程？',
        outputTemplate: ['我的选择：', '即时收益：', '长期风险：', '支持证据：', '不能确定：', '边界结论：'],
        rubric: ['判断符合送水人身份和信息限制。', '收益与风险权衡完整。', '至少引用三条证据。', '避免后见之明和现代安全标准直套。'],
        sentenceStarters: ['站在送水人的位置，我会……', '这个选择短期保护……', '但长期可能……', '来源只能说明……不能说明……'],
        linkedSourceTitles: ['British Parliamentary Papers: correspondence respecting the Suez Canal', 'Colonialism and Revolution in the Middle East'],
      },
      {
        id: 'suez-source-progress-boundary',
        title: '校准“基础设施进步”说法',
        instruction: '说明苏伊士运河为什么可以被称为全球航运基础设施，也必须被写成劳役、淡水和疾病风险的劳动系统。',
        evidenceUse: '比较公司/工程报告、机构历史和 scholarship 的证据层级，至少引用一条 scene beat。',
        deliverable: '一张史料判断卡：可说 / 不能说 / 还需证据 / 缺席声音。',
        estimatedMinutes: 32,
        difficulty: '挑战',
        taskType: '史料判断',
        steps: ['选择至少四条不同类型来源。', '写出它们共同支持的谨慎判断。', '列出“进步叙事”可能遮蔽的两个劳动代价。', '指出送水人、病人或村庄家庭声音为何缺席。'],
        evidenceChecklist: ['至少包含 primary、institution、scholarship 各一条。', '明确写出“工程/国家/欧洲观察者/后世学者”至少两项视角限制。', '包含谨慎替代表述。'],
        reflectionPrompt: '历史解释为什么必须同时写能力增长和代价转移？',
        outputTemplate: ['可谨慎说：', '不能直接说：', '支持来源：', '来源限制：', '缺席声音：', '替代表述：'],
        rubric: ['来源类型判断准确。', '能区分工程事实与劳动体验。', '明确指出缺席声音。', '结论语言谨慎、可被证据支撑。'],
        sentenceStarters: ['现有证据可以支持……', '但不能直接推出……', '这条来源需要谨慎，因为……', '更稳妥的表述是……'],
        linkedSourceTitles: ['Compagnie universelle du canal maritime de Suez reports and correspondence', 'Suez Canal Authority: history of the canal', 'Parting the Desert: The Creation of the Suez Canal', 'Egypt in the Nineteenth Century: Mehemet Ali to British Occupation'],
      },
    ],
    socialActors: [
      {
        id: 'self',
        name: '三角洲劳役送水人',
        role: '背水、递水、搬土，并在工棚核对名单记号',
        relationship: '核心决策者；既要服从路线和点名，也要面对同村病人、家中债务和同伴信任。',
        goals: '活着回村、少受惩罚、帮同村人喝到水或避免错误缺勤记号，同时不被中间人盯上。',
        constraints: '被征调到工地，行动受点名、工头、路线、口粮和记录系统限制；医学知识、金钱和上诉渠道都有限。',
        knowledgeLimits: '知道工棚和水路情况，却不了解公司外交谈判、工程整体进度或后世航运影响。',
        risksOrStakes: '疾病、晒伤、惩罚、口粮减少、债务加重、同伴失信或被错误记录为逃工/缺勤。',
        likelyViewOfDecision: '倾向在继续送水和照看病人之间寻找折中，若能信任书记员则尝试把病人记为病号。',
        evidenceLinks: ['水囊比工程图更沉', '工棚名单上的黑点', '决策选项'],
      },
      {
        id: 'village-mediator',
        name: '村庄中间人 / 工棚小头目',
        role: '传达征调名单、协调点名、向上级解释缺勤和病号',
        relationship: '来自相近村庄或熟悉地方关系；既可能帮忙说情，也可能把压力转嫁给劳役者。',
        goals: '完成上级要求、减少逃离或混乱、保住自己在村庄和工地之间的位置。',
        constraints: '受官府、公司工地、村庄关系和劳役者怨气夹击，资源有限。',
        knowledgeLimits: '知道名单和地方关系，但不一定了解病情、淡水系统或国际压力。',
        risksOrStakes: '若人手不足或记录混乱，可能被上级追责；若过度压迫，也会失去同村人的信任。',
        likelyViewOfDecision: '可能支持找书记员求情，但会要求送水人不要让路线完全中断。',
        evidenceLinks: ['村名先被喊进沙地', '工棚名单上的黑点'],
      },
      {
        id: 'company-engineer',
        name: '运河公司工程师',
        role: '监督开挖、淡水供应和工程进度的欧洲技术人员',
        relationship: '通常通过工头、译员和记录接触劳役者；把水、土方和人力视为工程问题。',
        goals: '保持进度、解决淡水和后勤瓶颈、向公司或投资者证明工程可行。',
        constraints: '受资金、技术、气候、劳动力安排、埃及政府和外交批评限制。',
        knowledgeLimits: '掌握工程图和报告语言，却可能低估营地疾病、村庄债务和劳役者心理压力。',
        risksOrStakes: '进度失败或国际批评会影响公司声誉和职业前途；过度依赖劳役也会加剧政治争议。',
        likelyViewOfDecision: '倾向要求水路不中断，同时可能把病号处理交给下级记录系统。',
        evidenceLinks: ['水囊比工程图更沉', 'Compagnie universelle du canal maritime de Suez reports and correspondence'],
      },
      {
        id: 'camp-scribe',
        name: '工棚书记员',
        role: '记录点名、缺勤、病号、口粮或工段安排',
        relationship: '掌握名单和记号，能帮助或伤害低位劳役者；送水人因略识字与他有接触。',
        goals: '让名单、口粮和人力调度看起来可管理，减少上级追问。',
        constraints: '必须把复杂病情、逃离、延误和村庄关系压缩成简单记号。',
        knowledgeLimits: '看到的是名单和报告，不一定理解每个缺勤背后的疾病、家庭或水路压力。',
        risksOrStakes: '记录错误会引发纠纷；记录过于宽松或过于严厉都可能招来上级或劳役者不满。',
        likelyViewOfDecision: '如果求情有中间人背书，可能愿意把病人记为病号；否则倾向按规则记录延误。',
        evidenceLinks: ['村名先被喊进沙地', '工棚名单上的黑点'],
      },
    ],
    socialEncounters: [
      {
        id: 'sick-worker-water-list-negotiation',
        title: '病人、水路与名单协商',
        setting: '正午沟槽边到夜间工棚之间，送水人、同村病人、中间人和书记员围绕一次延误如何记录发生争执。',
        decisionFocus: '是先保住送水路线、先救病人，还是先把病号写进名单以减少后续惩罚？',
        actorIds: ['self', 'village-mediator', 'company-engineer', 'camp-scribe'],
        tension: '工程进度需要水路不中断，病人需要立刻照看，中间人需要名单平稳，书记员需要可记录的类别；同一事件在不同人眼中是延误、疾病、互助或管理问题。',
        evidenceLinks: ['水囊比工程图更沉', '工棚名单上的黑点', '决策选项', '来源层'],
        taskChecklist: ['选择至少两位行动者比较立场', '标出每位行动者的目标与风险', '区分即时照看和记录后果', '引用一条来源可靠性边界', '形成一条有条件的行动判断'],
      },
      {
        id: 'dawn-roll-call-pressure',
        title: '黎明点名压力链',
        setting: '工棚外的点名队列，村庄中间人、书记员、工头和送水人共同确认谁还在场。',
        decisionFocus: '名单是在保护口粮和病号，还是把人压成可惩罚的缺勤记号？',
        actorIds: ['self', 'village-mediator', 'camp-scribe'],
        tension: '劳役者希望名单承认疾病和同伴互助，记录系统却更容易需要清楚、快速、可汇报的类别。',
        evidenceLinks: ['村名先被喊进沙地', '工棚名单上的黑点'],
        taskChecklist: ['列出点名中被记录的项目', '说明一个可保护劳役者的记录用途', '说明一个会伤害劳役者的记录用途', '写出缺席声音'],
      },
    ],
    materialObjects: [
      {
        id: 'suez-water-skin',
        name: '皮水囊与木碗',
        category: 'supply object',
        shortLabel: '水囊',
        description: '皮水囊和木碗把“淡水供应”这个工程问题变成肩膀、路线、等待和分配次序。',
        objectBiography: '水囊在分发点、沟槽、病棚和工棚之间移动；它未必作为文物保存，却每天决定开挖队能否继续工作。',
        everydayUse: '送水人背着水囊沿工段递水、补水、判断谁最急需，也可能把少量水留给病人或同村人。',
        laborOrSkill: '需要辨认路线、保持水量、在工头催促和同伴求助之间分配体力与判断。',
        exchangeOrPower: '谁控制水路、分发顺序和水质，谁就控制工地上最基本的生存条件；淡水系统也让低位送水人成为关键但易被忽视的节点。',
        evidenceLimit: '水囊可帮助理解淡水劳动，但不能证明具体水量、水质、工时或某一次争执。',
        linkedSourceTitles: ['Suez Canal Authority: history of the canal', 'Encyclopaedia Britannica: Suez Canal'],
        linkedSceneBeatTitles: ['水囊比工程图更沉', '蒸汽船捷径从病棚旁经过'],
        inquiryPrompts: ['这件物如何把工程图和身体劳动连接起来？', '谁决定水先到哪里？', '如果只看水渠或地图，哪些劳动会消失？'],
        tags: ['material culture', 'freshwater', 'labor', 'supply', 'infrastructure'],
      },
      {
        id: 'suez-camp-roster-charcoal',
        name: '工棚名单与炭笔记号',
        category: 'record object',
        shortLabel: '名单记号',
        description: '名单、村名和炭笔记号把劳役者转成在场、缺勤、病号、欠账或等待处理的类别。',
        objectBiography: '纸页或木板可能由书记员、工头或中间人使用，在点名、口粮、工段调度和争议中反复修改。',
        everydayUse: '夜里送水人帮同伴辨认姓名、村名和记号，提醒谁需要求情、谁可能被误记。',
        laborOrSkill: '显示低位识字、核对、翻译规则和解释记号的劳动；这类劳动处在同伴互助和权力执行之间。',
        exchangeOrPower: '记录能给病人争取承认，也能固定缺勤、欠账和惩罚；书记员和中间人因此拥有很大解释权。',
        evidenceLimit: '现有公开材料很少保存普通工棚具体名单；本物件是基于记录系统的教学重构，不能当作真实名单原件。',
        linkedSourceTitles: ['British Parliamentary Papers: correspondence respecting the Suez Canal', 'Colonialism and Revolution in the Middle East'],
        linkedSceneBeatTitles: ['村名先被喊进沙地', '工棚名单上的黑点'],
        inquiryPrompts: ['名单怎样同时保护和控制劳役者？', '识字为什么会带来责任风险？', '没有劳役者自述时，记录物能证明到哪一步？'],
        tags: ['material culture', 'records', 'corvée', 'source limits', 'bureaucracy'],
      },
      {
        id: 'suez-canal-spade-basket',
        name: '铁锹、篮筐与泥土箩',
        category: 'work object',
        shortLabel: '锹与筐',
        description: '铁锹和篮筐代表早期开挖阶段大量人工挖土、搬运和重复动作，而不是单纯机器化工程。',
        objectBiography: '工具在工段、沟槽和堤边循环，被不同劳役者使用、修补和传递；它们比工程庆典更贴近日常开挖。',
        everydayUse: '即便你主要送水，也常需要帮忙搬筐、清泥或递工具，水路和挖土不是完全分开的工作。',
        laborOrSkill: '显示体力节奏、工段配合和对泥沙/盐碱地的经验判断。',
        exchangeOrPower: '工具分发和工段安排由上级控制，劳动成果却被纳入公司进度、国家工程和全球航运叙事。',
        evidenceLimit: '能支持人工劳动强度的讨论，但不能给出具体每人日挖量、工时或伤亡数字。',
        linkedSourceTitles: ['Compagnie universelle du canal maritime de Suez reports and correspondence', 'Parting the Desert: The Creation of the Suez Canal'],
        linkedSceneBeatTitles: ['村名先被喊进沙地', '水囊比工程图更沉'],
        inquiryPrompts: ['工具如何提醒我们“运河”首先是重复劳动？', '哪些劳动会被工程进度语言吸收？', '如何避免从工具直接推断精确工时？'],
        tags: ['material culture', 'excavation', 'manual labor', 'canal', 'progress narrative'],
      },
    ],
    keyTerms: [
      { term: 'corvée labor', definition: '国家或地方权力征调民众服役的劳役制度；在苏伊士运河早期开挖争议中，埃及农民劳役是核心问题之一。' },
      { term: 'fellah', definition: '阿拉伯语语境中常指埃及农民；欧洲和国家材料常把他们作为劳动力类别记录，容易压低个人差异和声音。' },
      { term: 'freshwater canal', definition: '为工地和地峡地区供水而建设/使用的淡水系统；它是技术设施，也依赖分发、维护和送水劳动。' },
      { term: 'Compagnie universelle du canal maritime de Suez', definition: '苏伊士运河公司，负责推动和管理运河工程的欧洲资本公司；其报告体现公司和工程视角。' },
      { term: 'infrastructure progress', definition: '以道路、运河、铁路、水渠等系统提升流动能力的进步叙事；历史分析需同时追问谁承担建设和维护代价。' },
      { term: 'source silence', definition: '来源没有保存或很少保存某些人的直接声音；本场景尤其指劳役送水人、病人和村庄家庭的缺席。' },
      { term: 'steam route', definition: '19 世纪蒸汽航运和全球商品流动依赖的时间/空间网络；苏伊士运河后来显著改变这些路线，但不能倒推出开挖者的收益。' },
    ],
    compareAngles: [
      { title: '运河 vs. 工厂', prompt: '苏伊士送水人、曼彻斯特纺织工和孟买女工都服务于“更快”的系统：速度提升如何被转化为身体风险和纪律？' },
      { title: '淡水供应 vs. 港口信用', prompt: '苏伊士淡水线、Fustat 信件和马六甲港口税册都是流动系统的瓶颈；它们分别需要哪些中介劳动？' },
      { title: '工程报告 vs. 劳动体验', prompt: '公司报告、外交通信和机构历史能说明工程什么？它们为什么难以替劳役者发声？' },
      { title: '基础设施进步 vs. 代价转移', prompt: '当后世称一条路线改变世界时，课堂论证如何同时写出真实连接能力和普通人的不可量化代价？' },
    ],
    sourceEvidenceUse:
      '先用运河公司报告、工程通信和英国外交通信识别 1860s 开挖、劳役争议、淡水供应和国际压力等结构性线索；再用 Suez Canal Authority 与 Britannica 校准工程阶段、地点和 1869 通航等基本框架；用 Karabell、Cole 和埃及/中东 19 世纪研究把运河放入欧洲资本、埃及国家建设、劳役制度、债务和英国占领背景。所有来源只做短摘记/转述，不放长版权原文；工程公司、国家、欧洲观察者、机构历史和后世学者各有视角。使用时必须说明劳役者本人声音很少直接保存，不能把工程进度、通航意义、淡水设施或外交争议自动等同于送水人的劳动体验，也不要编造具体死亡人数、工资、工时或个人原话。',
    sources: [
      {
        title: 'Compagnie universelle du canal maritime de Suez reports and correspondence',
        creator: 'Suez Canal Company / Ferdinand de Lesseps and company officials',
        sourceType: 'primary',
        relevance: '公司报告、通信和宣传性材料可提供工程进度、淡水、劳动力和公司自我解释线索。',
        excerpt: '材料常把运河开挖、供水、设备和人力安排写成工程与管理问题，显示公司如何向投资者和公众解释工程可行性。',
        sourceQuestion: '公司材料能证明哪些工程和管理关注？它为什么可能压低劳役者身体经验和不满？',
        reliabilityNote: '接近工程管理现场，但有公司利益、宣传和进度证明目的；不能单独还原普通送水人、病人或工棚生活。',
        perspective: '欧洲公司、工程管理和资本动员视角',
        evidenceTags: ['Suez Canal', 'company records', 'engineering', 'freshwater', 'labor management', 'source limits'],
      },
      {
        title: 'British Parliamentary Papers: correspondence respecting the Suez Canal',
        creator: 'British Foreign Office and parliamentary papers compilers',
        sourceType: 'primary',
        relevance: '英国外交和议会材料记录围绕运河、劳役、埃及政府和欧洲公司之间的争议，是理解国际压力的重要线索。',
        excerpt: '通信把运河问题放在外交、商业和政治竞争中讨论，常提及劳动力安排和对工程的批评或担忧。',
        sourceQuestion: '外交通信如何把劳役问题变成国际政治问题？它又如何过滤普通劳役者的声音？',
        reliabilityNote: '能显示英国官方关切和外交语境，但带有帝国战略、商业利益和政策立场；不是劳役者自述。',
        perspective: '英国外交、议会和帝国战略观察者视角',
        evidenceTags: ['diplomacy', 'corvée', 'British Empire', 'political pressure', 'absent voices'],
      },
      {
        title: 'Suez Canal Authority: history of the canal',
        creator: 'Suez Canal Authority',
        sourceType: 'institution',
        relevance: '机构历史提供运河工程阶段、关键地点、淡水渠和通航框架，便于校准基本时空背景。',
        excerpt: '机构叙述强调运河开挖、通航、扩建和交通意义，帮助定位工程节点和后续历史。',
        sourceQuestion: '机构历史能帮助我们确认哪些基本事实？它为什么可能更强调成就而非劳役体验？',
        reliabilityNote: '适合核对框架、地点和工程节点；作为后世机构叙述，往往以运河成就和国家/交通意义为中心。',
        perspective: '现代运河管理机构和国家基础设施记忆视角',
        evidenceTags: ['institution source', 'canal history', 'freshwater canal', 'navigation', 'memory'],
        url: 'https://www.suezcanal.gov.eg/',
      },
      {
        title: 'Encyclopaedia Britannica: Suez Canal',
        creator: 'Encyclopaedia Britannica editors',
        sourceType: 'institution',
        relevance: '提供苏伊士运河地理、开挖、通航和全球航运影响的简明背景。',
        excerpt: '条目把运河定义为连接地中海与红海的人工水道，并概述建设、开通和世界交通意义。',
        sourceQuestion: '百科背景适合回答哪些“是什么/何时/在哪里”问题？为什么不足以回答劳役者如何承受工程？',
        reliabilityNote: '可靠的概览型参考，但高度压缩，通常不会展开营地疾病、送水劳动或来源沉默。',
        perspective: '现代百科概述和全球交通史视角',
        evidenceTags: ['reference', 'canal geography', 'global shipping', 'overview', 'source limits'],
        url: 'https://www.britannica.com/topic/Suez-Canal',
      },
      {
        title: 'Parting the Desert: The Creation of the Suez Canal',
        creator: 'Zachary Karabell',
        sourceType: 'scholarship',
        relevance: '综合叙述苏伊士运河的政治、公司、工程和全球背景，可帮助把 1860s 工地放入更大脉络。',
        excerpt: '研究把 Lesseps、埃及统治者、欧洲投资、外交压力和工程困难联系起来，显示运河并非单纯技术项目。',
        sourceQuestion: '现代综合研究如何连接公司、国家和全球交通？它如何处理普通劳役者声音不足的问题？',
        reliabilityNote: '可作为英文综合背景，但具体劳役者日常仍需与 primary 和其他社会史研究并读，不能把叙事细节当作送水人自述。',
        perspective: '现代运河政治史、工程史和全球史综合视角',
        evidenceTags: ['scholarship', 'Suez Canal creation', 'imperial capitalism', 'engineering', 'global routes'],
      },
      {
        title: 'Colonialism and Revolution in the Middle East',
        creator: 'Juan R. I. Cole',
        sourceType: 'scholarship',
        relevance: '关于 19 世纪埃及、殖民压力、资本、劳役和国家建设的研究，有助于把苏伊士放入社会政治结构。',
        excerpt: '研究强调埃及国家、欧洲资本、债务、社会力量和帝国干预之间的关系，提醒读者不要只从工程成功解释运河。',
        sourceQuestion: '把运河放进埃及国家建设和殖民压力中，会如何改变我们对“进步”的判断？',
        reliabilityNote: '现代社会政治史能校准结构解释；仍不能替代劳役者个人口述，课堂使用需标注推论层级。',
        perspective: '现代中东社会史、殖民主义和政治经济视角',
        evidenceTags: ['Egypt', 'corvée', 'state building', 'debt', 'colonialism', 'labor'],
      },
    ],
  },
