...
- 学习档案袋汇总全站完成数、草稿数、最近草稿、跨场景工作区条目、Route Inquiry Notebook、史料互证草稿和勾选数，并支持复制包含互证草稿 section 的全部学习档案
