...
- Archive & Evidence Atlas / 全站史料证据地图 1.0：直接汇总现有 scenarios[].sources（不改变 scenario 数据结构），支持全站来源搜索、来源类型/场景/证据标签筛选、类型数量快照、高频标签、档案空白 prompt、Source Reader 跳转、来源可信度 Compare Lens 启动、2-4 条 Evidence Basket 和可复制“史料判断”工作纸
- 场景卡片与总览中的进度徽章
