...
- 使用年份和坐标生成的轻量时间地图概览
- Time-Space Atlas / Route Explorer 12.1：基于现有 scenario 年份、坐标、地区与主题生成互动地图 pins、route polyline、时间轨、场景预览、地区/主题筛选、路线卡、状态徽章、Compare Lab 启动按钮、可复制/导出的路线作业单，以及按本机持久保存的 Route Inquiry Notebook；内置 5 条策展路线（知识城市、市场走廊、危机新闻、劳动纪律与安全、工业城市与全球交换）
- 场景卡片与总览中的进度徽章
