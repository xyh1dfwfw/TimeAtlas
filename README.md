...
- 学习档案袋汇总全站完成数、草稿数、最近草稿、跨场景工作区条目、Route Inquiry Notebook、史料互证草稿、因果草稿、分期草稿、多视角草稿、情境化草稿、历史意义草稿和勾选数，并支持复制包含互证/因果/分期/多视角/情境化/历史意义草稿 section 的全部学习档案
- Task Library / Assignment Launcher 11.0：全站汇总 scenario missions、Activity Packs、Lesson Pack 课堂流程、Inquiry Pathways、Causation inquiries、Periodization inquiries、Perspectives inquiries、Contextualization inquiries、Significance inquiries 和 Compare Lens 模板，支持关键词、类别、场景、时长、来源和来源型任务筛选；任务卡展示情境、类别、时长、摘要、交付物、标签，并可打开对应场景、载入 Compare / Causation / Periodization / Perspectives / Context / Significance Lab 或复制统一格式的任务单
